...
public class RecordsAdapter extends ArrayAdapter<File> {
    ...
    public RecordsAdapter(Context context, ArrayList<File> files) {
        super(context, R.layout.record_list_item, files);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View rowView = ((LayoutInflater) this.context.getSystemService("layout_inflater")).inflate(R.layout.record_list_item, parent, false);
        TextView NameView = (TextView) rowView.findViewById(R.id.record_item_title);
        TextView durationView = (TextView) rowView.findViewById(R.id.record_item_duration);
        ...
        ((Button) rowView.findViewById(R.id.record_item_trash_button)).setOnClickListener(new FileDeletorOnClickListener((File) getItem(position), this));
        return rowView;
    }
}
