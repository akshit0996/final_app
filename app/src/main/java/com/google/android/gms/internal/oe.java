...
public final class oe implements SafeParcelable {
    ...
    public static final oe akb = m3493A("test_type", 1);
    public static final oe akc = m3493A("labeled_place", 6);
    ...
    /* renamed from: A */
    private static oe m3493A(String str, int i) {
