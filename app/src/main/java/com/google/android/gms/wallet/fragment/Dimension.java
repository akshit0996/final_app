...
public class Dimension {
    ...
    /* renamed from: a */
    public static int m2224a(long j, DisplayMetrics displayMetrics) {
        int i = (int) (j >>> 32);
        int i2 = (int) j;
        switch (i) {
            case 0:
    ...
    /* renamed from: a */
    public static long m2225a(int i, float f) {
        switch (i) {
            case 0:
            case 1:
            case 2:
            ...
            case 4:
            case 5:
                return m2227p(i, Float.floatToIntBits(f));
            default:
    ...
    /* renamed from: a */
    public static long m2226a(TypedValue typedValue) {
        switch (typedValue.type) {
            case 5:
                return m2227p(128, typedValue.data);
            case 16:
    ...
    /* renamed from: p */
    private static long m2227p(int i, int i2) {
