...
public class hh implements SafeParcelable {
    ...
    private static final hp CW = new C0457a("SsbContext").m1404G(true).at("blob").fG();
    final int CK;
    ...
    hh(int i, String str, hp hpVar, int i2, byte[] bArr) {
        boolean z = i2 == CV || ho.m1403P(i2) != null;
        jx.m1580b(z, "Invalid section type " + i2);
        this.CK = i;
        this.CX = str;
        this.CY = hpVar;
        this.CZ = i2;
    ...
    public String fE() {
        return (this.CZ == CV || ho.m1403P(this.CZ) != null) ? (this.CX == null || this.Da == null) ? null : "Both content and blobContent set" : "Invalid section type " + this.CZ;
    }

    public void writeToParcel(Parcel dest, int flags) {
        hi hiVar = CREATOR;
        hi.m1391a(this, dest, flags);
    }
}
