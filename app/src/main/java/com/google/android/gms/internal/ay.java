...
public final class ay implements SafeParcelable {
    ...
    public ay(Context context, AdSize[] adSizeArr) {
        ...
        if (i4 != 0) {
            this.widthPixels = m3050a(displayMetrics);
            i = (int) (((float) this.widthPixels) / displayMetrics.density);
        } else {
            i2 = this.width;
            this.widthPixels = gq.m1332a(displayMetrics, this.width);
            i = i2;
        }
        i2 = i5 != 0 ? m3052c(displayMetrics) : this.height;
        this.heightPixels = gq.m1332a(displayMetrics, i2);
        if (i4 == 0 && i5 == 0) {
    ...
    /* renamed from: a */
    public static int m3050a(DisplayMetrics displayMetrics) {
        return displayMetrics.widthPixels;
    }

    /* renamed from: b */
    public static int m3051b(DisplayMetrics displayMetrics) {
        return (int) (((float) m3052c(displayMetrics)) * displayMetrics.density);
    }

    /* renamed from: c */
    private static int m3052c(DisplayMetrics displayMetrics) {
        int i = (int) (((float) displayMetrics.heightPixels) / displayMetrics.density);
        return i <= 400 ? 32 : i <= 720 ? 50 : 90;
    }

    public AdSize bh() {
        return C0101a.m10a(this.width, this.height, this.op);
    }
