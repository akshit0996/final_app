...
public final class CameraUpdateFactory {
    ...
    /* renamed from: a */
    public static void m1944a(ICameraUpdateFactoryDelegate iCameraUpdateFactoryDelegate) {
        akl = (ICameraUpdateFactoryDelegate) jx.m1582i(iCameraUpdateFactoryDelegate);
    }

    private static ICameraUpdateFactoryDelegate nB() {
        return (ICameraUpdateFactoryDelegate) jx.m1578b(akl, (Object) "CameraUpdateFactory is not initialized");
    }
