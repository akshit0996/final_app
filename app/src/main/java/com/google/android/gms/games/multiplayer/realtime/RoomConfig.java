...
public abstract class RoomConfig {
    ...
    public static final class Builder {
        ...
        private Builder(RoomUpdateListener updateListener) {
            ...
            this.aen = false;
            this.aeh = (RoomUpdateListener) jx.m1578b((Object) updateListener, (Object) "Must provide a RoomUpdateListener");
        }
        ...
        public Builder setVariant(int variant) {
            ...
            jx.m1580b(z, (Object) "Variant must be a positive integer or Room.ROOM_VARIANT_ANY");
            this.adW = variant;
            return this;
        }
    }
