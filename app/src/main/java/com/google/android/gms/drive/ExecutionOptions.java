...
public final class ExecutionOptions {
    ...
    /* renamed from: a */
    public static void m275a(GoogleApiClient googleApiClient, ExecutionOptions executionOptions) {
        C1317r c1317r = (C1317r) googleApiClient.mo925a(Drive.DQ);
        if (executionOptions.iw() && !c1317r.iJ()) {
