...
public class ev implements InAppPurchase {
    ...
    public String getProductId() {
        try {
            ...
            gr.m1345d("Could not forward getProductId to InAppPurchase", e);
            return null;
        }
    }
    ...
    public void recordPlayBillingResolution(int billingResponseCode) {
        try {
            ...
            gr.m1345d("Could not forward recordPlayBillingResolution to InAppPurchase", e);
        }
    }
    ...
    public void recordResolution(int resolution) {
        try {
            ...
            gr.m1345d("Could not forward recordResolution to InAppPurchase", e);
        }
    }
}
