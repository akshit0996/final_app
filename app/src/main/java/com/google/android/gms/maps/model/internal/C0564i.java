...
public interface C0564i extends IInterface {

    /* renamed from: com.google.android.gms.maps.model.internal.i$a */
    public static abstract class C1169a extends Binder implements C0564i {

        /* renamed from: com.google.android.gms.maps.model.internal.i$a$a */
        private static class C1168a implements C0564i {
            private IBinder le;
            ...
            /* renamed from: a */
            public void mo2377a(float f, float f2) throws RemoteException {
            ...
            /* renamed from: a */
            public void mo2378a(C1161a c1161a) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
            ...
            /* renamed from: a */
            public boolean mo2379a(C0564i c0564i) throws RemoteException {
                boolean z = false;
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
                    obtain.writeStrongBinder(c0564i != null ? c0564i.asBinder() : null);
            ...
            /* renamed from: m */
            public void mo2390m(C0272d c0272d) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
        ...
        public static C0564i bx(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0564i)) ? new C1168a(iBinder) : (C0564i) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 6:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
                    mo2377a(data.readFloat(), data.readFloat());
                    reply.writeNoException();
                    return true;
                case 7:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
                ...
                case TimeUtils.HUNDRED_DAY_FIELD_LEN /*19*/:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
                    isVisible = mo2379a(C1169a.bx(data.readStrongBinder()));
                    reply.writeNoException();
                    if (isVisible) {
                        i = 1;
                    }
                ...
                case 21:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
                    mo2390m(C0871a.ap(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 22:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
                    if (data.readInt() != 0) {
                        c1161a = C1161a.CREATOR.dp(data);
                    }
                    mo2378a(c1161a);
                    reply.writeNoException();
                    return true;
    ...
    /* renamed from: a */
    void mo2377a(float f, float f2) throws RemoteException;

    /* renamed from: a */
    void mo2378a(C1161a c1161a) throws RemoteException;

    /* renamed from: a */
    boolean mo2379a(C0564i c0564i) throws RemoteException;
    ...
    /* renamed from: m */
    void mo2390m(C0272d c0272d) throws RemoteException;
