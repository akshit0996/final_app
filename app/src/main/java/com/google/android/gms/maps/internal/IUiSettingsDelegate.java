...
public interface IUiSettingsDelegate extends IInterface {
    ...
    public static abstract class C1114a extends Binder implements IUiSettingsDelegate {

        /* renamed from: com.google.android.gms.maps.internal.IUiSettingsDelegate$a$a */
        private static class C1113a implements IUiSettingsDelegate {
            private IBinder le;
        ...
        public static IUiSettingsDelegate bu(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IUiSettingsDelegate)) ? new C1113a(iBinder) : (IUiSettingsDelegate) queryLocalInterface;
        }
