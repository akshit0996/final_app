...
public final class AppContentCardRef extends MultiDataBufferRef implements AppContentCard {
    ...
    public boolean equals(Object obj) {
        return AppContentCardEntity.m4031a(this, obj);
    }
    ...
    public List<AppContentAction> getActions() {
        return AppContentUtils.m673a(this.JG, this.XX, "card_actions", this.KZ);
    }
    ...
    public int hashCode() {
        return AppContentCardEntity.m4030a(this);
    }

    public List<AppContentCondition> kH() {
        return AppContentUtils.m676c(this.JG, this.XX, "card_conditions", this.KZ);
    }
    ...
    public List<AppContentAnnotation> kN() {
        return AppContentUtils.m675b(this.JG, this.XX, "card_annotations", this.KZ);
    }
    ...
    public Bundle kP() {
        return AppContentUtils.m677d(this.JG, this.XX, "card_data", this.KZ);
    }
    ...
    public String toString() {
        return AppContentCardEntity.m4032b(this);
    }
