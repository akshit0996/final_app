...
class qt {
    ...
    private byte[] toByteArray() throws IOException {
        ...
        m1899a(qp.m1856q(bArr));
        return bArr;
    }

    /* renamed from: a */
    void m1899a(qp qpVar) throws IOException {
        if (this.aze != null) {
            this.azd.m1891a(this.aze, qpVar);
            return;
        }
        for (qy a : this.azf) {
            a.m1913a(qpVar);
    ...
    /* renamed from: a */
    void m1900a(qy qyVar) {
        this.azf.add(qyVar);
    }

    /* renamed from: b */
    <T> T m1901b(qr<?, T> qrVar) {
        if (this.aze == null) {
            this.azd = qrVar;
            this.aze = qrVar.m1894m(this.azf);
            this.azf = null;
    ...
    int m1902c() {
        if (this.aze != null) {
            return this.azd.m1887B(this.aze);
        }
        int i = 0;
        for (qy c : this.azf) {
            i = c.m1914c() + i;
