...
public interface C0526b extends IInterface {

    /* renamed from: com.google.android.gms.maps.internal.b$a */
    public static abstract class C1116a extends Binder implements C0526b {

        /* renamed from: com.google.android.gms.maps.internal.b$a$a */
        private static class C1115a implements C0526b {
            private IBinder le;
        ...
        public static C0526b aR(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.ICancelableCallback");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0526b)) ? new C1115a(iBinder) : (C0526b) queryLocalInterface;
        }
