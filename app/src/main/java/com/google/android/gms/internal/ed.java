...
@ey
public final class ed extends C0942a {
    ...
    private void cz() {
        try {
            ...
            gr.m1341W("Google Conversion Tracking SDK 1.2.0 or above is required to report a conversion.");
        } catch (NoSuchMethodException e2) {
            gr.m1341W("Google Conversion Tracking SDK 1.2.0 or above is required to report a conversion.");
        } catch (Throwable e3) {
            gr.m1345d("Fail to report a conversion.", e3);
        }
    }

    /* renamed from: a */
    protected String m4366a(String str, HashMap<String, String> hashMap) {
        Object obj;
        Object obj2 = "";
        try {
            obj = this.mContext.getPackageManager().getPackageInfo(this.mContext.getPackageName(), 0).versionName;
        } catch (Throwable e) {
            gr.m1345d("Error to retrieve app version", e);
            obj = obj2;
        }
    ...
    public void recordPlayBillingResolution(int billingResponseCode) {
        ...
        hashMap.put("status", String.valueOf(m4367p(billingResponseCode)));
        Iterator it = this.sN.iterator();
        while (it.hasNext()) {
            new gp(this.mContext, this.mG, m4366a((String) it.next(), hashMap)).start();
        }
    }
