...
public interface C0544t extends IInterface {

    /* renamed from: com.google.android.gms.maps.internal.t$a */
    public static abstract class C1152a extends Binder implements C0544t {

        /* renamed from: com.google.android.gms.maps.internal.t$a$a */
        private static class C1151a implements C0544t {
            private IBinder le;

            C1151a(IBinder iBinder) {
                this.le = iBinder;
            }
        ...
        public static C0544t bn(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0544t)) ? new C1151a(iBinder) : (C0544t) queryLocalInterface;
        }
