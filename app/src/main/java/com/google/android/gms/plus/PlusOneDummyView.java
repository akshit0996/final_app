...
public class PlusOneDummyView extends FrameLayout {
    ...
    private static class C1192a implements C0590d {
    ...
    private static class C1193b implements C0590d {
        private Context mContext;

        private C1193b(Context context) {
            this.mContext = context;
        }
    ...
    private static class C1194c implements C0590d {
        private Context mContext;

        private C1194c(Context context) {
            this.mContext = context;
        }
    ...
    private C0590d ot() {
        C0590d c1193b = new C1193b(getContext());
        if (!c1193b.isValid()) {
            c1193b = new C1194c(getContext());
        }
        return !c1193b.isValid() ? new C1192a(getContext()) : c1193b;
    }
}
