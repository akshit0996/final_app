...
public final class ny implements SafeParcelable {
    ...
    public String toString() {
        return jv.m1571h(this).m1570a("filter", this.ahA).m1570a("interval", Long.valueOf(this.agr)).m1570a("priority", Integer.valueOf(this.mPriority)).toString();
    }

    public void writeToParcel(Parcel parcel, int flags) {
        nz nzVar = CREATOR;
        nz.m1748a(this, parcel, flags);
    }
}
