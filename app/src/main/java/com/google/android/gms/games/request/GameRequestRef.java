...
public final class GameRequestRef extends C0174d implements GameRequest {
    ...
    public boolean equals(Object obj) {
        return GameRequestEntity.m4260a(this, obj);
    }
    ...
    public int getRecipientStatus(String playerId) {
        for (int i = this.KZ; i < this.KZ + this.Ya; i++) {
            int au = this.JG.au(i);
            if (this.JG.m2493c("recipient_external_player_id", i, au).equals(playerId)) {
                return this.JG.m2492b("recipient_status", i, au);
            }
        }
        return -1;
    }
    ...
    public int hashCode() {
        return GameRequestEntity.m4259a(this);
    }
    ...
    public String toString() {
        return GameRequestEntity.m4262c(this);
    }
