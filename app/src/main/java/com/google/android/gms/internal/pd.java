...
public final class pd extends ks implements ItemScope {
    ...
    static {
        aom.put("about", C1017a.m3378a("about", 2, pd.class));
        aom.put("additionalName", C1017a.m3385m("additionalName", 3));
        aom.put("address", C1017a.m3378a("address", 4, pd.class));
        aom.put("addressCountry", C1017a.m3384l("addressCountry", 5));
        aom.put("addressLocality", C1017a.m3384l("addressLocality", 6));
        aom.put("addressRegion", C1017a.m3384l("addressRegion", 7));
        aom.put("associated_media", C1017a.m3379b("associated_media", 8, pd.class));
        aom.put("attendeeCount", C1017a.m3381i("attendeeCount", 9));
        aom.put("attendees", C1017a.m3379b("attendees", 10, pd.class));
        aom.put("audio", C1017a.m3378a("audio", 11, pd.class));
        aom.put("author", C1017a.m3379b("author", 12, pd.class));
        aom.put("bestRating", C1017a.m3384l("bestRating", 13));
        aom.put("birthDate", C1017a.m3384l("birthDate", 14));
        aom.put("byArtist", C1017a.m3378a("byArtist", 15, pd.class));
        aom.put("caption", C1017a.m3384l("caption", 16));
        aom.put("contentSize", C1017a.m3384l("contentSize", 17));
        aom.put("contentUrl", C1017a.m3384l("contentUrl", 18));
        aom.put("contributor", C1017a.m3379b("contributor", 19, pd.class));
        aom.put("dateCreated", C1017a.m3384l("dateCreated", 20));
        aom.put("dateModified", C1017a.m3384l("dateModified", 21));
        aom.put("datePublished", C1017a.m3384l("datePublished", 22));
        aom.put(PlusShare.KEY_CONTENT_DEEP_LINK_METADATA_DESCRIPTION, C1017a.m3384l(PlusShare.KEY_CONTENT_DEEP_LINK_METADATA_DESCRIPTION, 23));
        aom.put("duration", C1017a.m3384l("duration", 24));
        aom.put("embedUrl", C1017a.m3384l("embedUrl", 25));
        aom.put("endDate", C1017a.m3384l("endDate", 26));
        aom.put("familyName", C1017a.m3384l("familyName", 27));
        aom.put("gender", C1017a.m3384l("gender", 28));
        aom.put("geo", C1017a.m3378a("geo", 29, pd.class));
        aom.put("givenName", C1017a.m3384l("givenName", 30));
        aom.put("height", C1017a.m3384l("height", 31));
        aom.put("id", C1017a.m3384l("id", 32));
        aom.put("image", C1017a.m3384l("image", 33));
        aom.put("inAlbum", C1017a.m3378a("inAlbum", 34, pd.class));
        aom.put("latitude", C1017a.m3382j("latitude", 36));
        aom.put("location", C1017a.m3378a("location", 37, pd.class));
        aom.put("longitude", C1017a.m3382j("longitude", 38));
        aom.put("name", C1017a.m3384l("name", 39));
        aom.put("partOfTVSeries", C1017a.m3378a("partOfTVSeries", 40, pd.class));
        aom.put("performers", C1017a.m3379b("performers", 41, pd.class));
        aom.put("playerType", C1017a.m3384l("playerType", 42));
        aom.put("postOfficeBoxNumber", C1017a.m3384l("postOfficeBoxNumber", 43));
        aom.put("postalCode", C1017a.m3384l("postalCode", 44));
        aom.put("ratingValue", C1017a.m3384l("ratingValue", 45));
        aom.put("reviewRating", C1017a.m3378a("reviewRating", 46, pd.class));
        aom.put("startDate", C1017a.m3384l("startDate", 47));
        aom.put("streetAddress", C1017a.m3384l("streetAddress", 48));
        aom.put("text", C1017a.m3384l("text", 49));
        aom.put("thumbnail", C1017a.m3378a("thumbnail", 50, pd.class));
        aom.put(PlusShare.KEY_CONTENT_DEEP_LINK_METADATA_THUMBNAIL_URL, C1017a.m3384l(PlusShare.KEY_CONTENT_DEEP_LINK_METADATA_THUMBNAIL_URL, 51));
        aom.put("tickerSymbol", C1017a.m3384l("tickerSymbol", 52));
        aom.put("type", C1017a.m3384l("type", 53));
        aom.put(PlusShare.KEY_CALL_TO_ACTION_URL, C1017a.m3384l(PlusShare.KEY_CALL_TO_ACTION_URL, 54));
        aom.put("width", C1017a.m3384l("width", 55));
        aom.put("worstRating", C1017a.m3384l("worstRating", 56));
    }
    ...
    public boolean equals(Object obj) {
        ...
        for (C1017a c1017a : aom.values()) {
            if (mo3354a(c1017a)) {
                if (!pdVar.mo3354a(c1017a)) {
                    return false;
                }
                if (!mo3355b(c1017a).equals(pdVar.mo3355b(c1017a))) {
                    return false;
                }
            } else if (pdVar.mo3354a(c1017a)) {
                return false;
            }
        }
        return true;
