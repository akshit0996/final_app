...
public class ix {
    ...
    /* renamed from: a */
    public static String m1482a(Calendar calendar) {
        if (calendar == null) {
            Hh.m1470b("Calendar object cannot be null", new Object[0]);
            return null;
        }
        String str = Ir;
    ...
    /* renamed from: a */
    public static void m1483a(List<WebImage> list, JSONObject jSONObject) {
        try {
            list.clear();
    ...
    /* renamed from: a */
    public static void m1484a(JSONObject jSONObject, List<WebImage> list) {
    ...
    public static Calendar aL(String str) {
        if (TextUtils.isEmpty(str)) {
            Hh.m1470b("Input string is empty or null", new Object[0]);
            return null;
        }
        String aM = aM(str);
        if (TextUtils.isEmpty(aM)) {
            Hh.m1470b("Invalid date format", new Object[0]);
            return null;
        }
        String aN = aN(str);
        ...
        try {
            ...
            Hh.m1470b("Error parsing string: %s", e.getMessage());
            return null;
        }
    }
    ...
    private static String aM(String str) {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            try {
                ...
                Hh.m1471c("Error extracting the date: %s", e.getMessage());
            }
        }
        return str2;
    }
    ...
    private static String aN(String str) {
        if (TextUtils.isEmpty(str)) {
            Hh.m1470b("string is empty or null", new Object[0]);
            return null;
        }
        int indexOf = str.indexOf(84);
        int i = indexOf + 1;
        if (indexOf != "yyyyMMdd".length()) {
            Hh.m1470b("T delimeter is not found", new Object[0]);
            return null;
        }
        try {
            ...
            Hh.m1470b("Error extracting the time substring: %s", e.getMessage());
            return null;
        }
    }
