...
public interface C0534j extends IInterface {

    /* renamed from: com.google.android.gms.maps.internal.j$a */
    public static abstract class C1132a extends Binder implements C0534j {

        /* renamed from: com.google.android.gms.maps.internal.j$a$a */
        private static class C1131a implements C0534j {
            private IBinder le;

            C1131a(IBinder iBinder) {
                this.le = iBinder;
            }
        ...
        public static C0534j bd(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.IOnMapClickListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0534j)) ? new C1131a(iBinder) : (C0534j) queryLocalInterface;
        }
