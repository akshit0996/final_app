...
public class eh {
    ...
    public class C0410a extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            gr.m1339U("Database updated from version " + oldVersion + " to version " + newVersion);
    ...
    private eh(Context context) {
        this.ta = new C0410a(this, context, "google_inapp_purchase.db");
    }

    /* renamed from: j */
    public static eh m1161j(Context context) {
        eh ehVar;
        synchronized (mH) {
            if (tb == null) {
                tb = new eh(context);
    ...
    /* renamed from: b */
    public void m1164b(com.google.android.gms.internal.ef r7) {
        /*
        r6 = this;
            ...
            try {
                ...
                if (query != null) {
                    try {
                        ...
                        e = e2;
                        try {
                            gr.m1341W("Error remove oldest record" + e.getMessage());
                            if (query != null) {
                                query.close();
                            }
                        } catch (Throwable th2) {
        ...
        synchronized (mH) {
            ...
            try {
                ...
                try {
                    ...
                    e = e2;
                    try {
                        gr.m1341W("Error extracing purchase info: " + e.getMessage());
                        if (query != null) {
                            query.close();
                        }
                        return linkedList;
        ...
        synchronized (mH) {
            ...
            if (writableDatabase == null) {
                ...
                try {
                    ...
                    gr.m1341W("Error getting record count" + e.getMessage());
                    if (cursor != null) {
                        cursor.close();
                    }
                } catch (Throwable th) {
    ...
    public SQLiteDatabase getWritableDatabase() {
        try {
            ...
            gr.m1341W("Error opening writable conversion tracking database");
            return null;
        }
    }
}
