...
public final class qo {
    ...
    private int ayP;
    private int ayQ;
    private int ayR = ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED;
    private int ayS;
    private int ayT = 64;
    ...
    /* renamed from: A */
    public static long m1831A(long j) {
        return (j >>> 1) ^ (-(1 & j));
    }

    /* renamed from: a */
    public static qo m1832a(byte[] bArr, int i, int i2) {
    ...
    /* renamed from: p */
    public static qo m1833p(byte[] bArr) {
        return m1832a(bArr, 0, bArr.length);
    }
    ...
    /* renamed from: a */
    public void m1834a(qw qwVar) throws IOException {
        int rG = rG();
    ...
    /* renamed from: a */
    public void m1835a(qw qwVar, int i) throws IOException {
        if (this.ayS >= this.ayT) {
            throw qv.rX();
        }
        this.ayS++;
    ...
    public int rL() {
        if (this.ayR == ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED) {
            return -1;
        }
    ...
    /* renamed from: s */
    public byte[] m1836s(int i, int i2) {
        if (i2 == 0) {
            return qz.azq;
        }
