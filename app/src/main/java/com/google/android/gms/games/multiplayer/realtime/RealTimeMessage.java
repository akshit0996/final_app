...
public final class RealTimeMessage implements Parcelable {
    public static final Creator<RealTimeMessage> CREATOR = new C03531();
    ...
    static class C03531 implements Creator<RealTimeMessage> {
        C03531() {
        }
    ...
    public RealTimeMessage(String senderParticipantId, byte[] messageData, int isReliable) {
        this.aee = (String) jx.m1582i(senderParticipantId);
        this.aef = (byte[]) ((byte[]) jx.m1582i(messageData)).clone();
        this.aeg = isReliable;
    }
