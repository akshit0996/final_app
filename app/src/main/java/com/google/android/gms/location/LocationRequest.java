...
public final class LocationRequest implements SafeParcelable {
    public static final C0520d CREATOR = new C0520d();
    ...
    public LocationRequest() {
        ...
        this.agt = ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED;
        this.agu = 0.0f;
        this.agv = 0;
    }
    ...
    /* renamed from: a */
    private static void m3558a(float f) {
        if (f < 0.0f) {
    ...
    /* renamed from: v */
    private static void m3559v(long j) {
        if (j < 0) {
    ...
    public LocationRequest setSmallestDisplacement(float smallestDisplacementMeters) {
        m3558a(smallestDisplacementMeters);
    ...
    public String toString() {
        ...
        if (this.agt != ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED) {
    ...
    public void writeToParcel(Parcel parcel, int flags) {
        C0520d.m1942a(this, parcel, flags);
    }
}
