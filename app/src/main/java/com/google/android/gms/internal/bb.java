...
public final class bb {
    ...
    public bb(Context context, AttributeSet attributeSet) {
        ...
        if (obj2 != null && r1 == null) {
            this.ot = m1043q(string);
        } else if (obj2 == null && r1 != null) {
            this.ot = m1043q(string2);
        } else if (obj2 == null || r1 == null) {
            throw new IllegalArgumentException("Required XML attribute \"adSize\" was missing.");
        } else {
            throw new IllegalArgumentException("Either XML attribute \"adSize\" or XML attribute \"supportedAdSizes\" should be specified, but not both.");
        }
        this.ou = obtainAttributes.getString(C0099R.styleable.AdsAttrs_adUnitId);
    ...
    /* renamed from: q */
    private static AdSize[] m1043q(String str) {
    ...
    /* renamed from: h */
    public AdSize[] m1044h(boolean z) {
