...
public class PopupManager {
    ...
    private static final class PopupManagerHCMR1 extends PopupManager implements OnAttachStateChangeListener, OnGlobalLayoutListener {
        ...
        public void mo1503l(View view) {
            ...
            if (view == null && (context instanceof Activity)) {
                ...
                GamesLog.m684o("PopupManager", "You have not specified a View to use as content view for popups. Falling back to the Activity content view which may not work properly in future versions of the API. Use setViewForPopups() to set your content view.");
                view = view2;
            }
            if (view != null) {
                m3018m(view);
            ...
            GamesLog.m685p("PopupManager", "No content view usable to display popups. Popups will not be displayed in response to this client's calls. Use setViewForPopups() to set your content view.");
        }
    ...
    /* renamed from: a */
    public static PopupManager m942a(GamesClientImpl gamesClientImpl, int i) {
    ...
    public void lT() {
        this.ZQ.m4122a(this.ZR.ZS, this.ZR.lW());
    }
