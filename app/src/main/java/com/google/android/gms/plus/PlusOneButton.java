...
import com.google.android.gms.plus.internal.C1203g;
...
public final class PlusOneButton extends FrameLayout {
    ...
    /* renamed from: G */
    private void m2028G(Context context) {
        if (this.any != null) {
            removeView(this.any);
        }
        this.any = C1203g.m3664a(context, this.mSize, this.anz, this.vf, this.anA);
        setOnPlusOneClickListener(this.anB);
        addView(this.any);
    }

    protected static int getAnnotation(Context context, AttributeSet attrs) {
        String a = ka.m1596a("http://schemas.android.com/apk/lib/com.google.android.gms.plus", "annotation", context, attrs, true, false, "PlusOneButton");
    ...
    protected static int getSize(Context context, AttributeSet attrs) {
        String a = ka.m1596a("http://schemas.android.com/apk/lib/com.google.android.gms.plus", "size", context, attrs, true, false, "PlusOneButton");
    ...
    public void initialize(String url, int activityRequestCode) {
        jx.m1576a(getContext() instanceof Activity, "To use this method, the PlusOneButton must be placed in an Activity. Use initialize(String, OnPlusOneClickListener).");
        this.vf = url;
