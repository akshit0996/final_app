...
public final class Marker {
    private final C0567l amo;

    public Marker(C0567l delegate) {
        this.amo = (C0567l) jx.m1582i(delegate);
    }
    ...
    public boolean equals(Object other) {
        ...
        try {
            return this.amo.mo2417h(((Marker) other).amo);
