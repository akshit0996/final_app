...
import com.google.android.gms.maps.internal.C0542r.C1148a;
import com.google.android.gms.maps.internal.C0543s.C1150a;
import com.google.android.gms.maps.internal.C0544t.C1152a;
...
public interface IStreetViewPanoramaDelegate extends IInterface {
    ...
    public static abstract class C1108a extends Binder implements IStreetViewPanoramaDelegate {

        /* renamed from: com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate$a$a */
        private static class C1107a implements IStreetViewPanoramaDelegate {
            private IBinder le;

            C1107a(IBinder iBinder) {
                this.le = iBinder;
            }
            ...
            public C0272d orientationToPoint(StreetViewPanoramaOrientation orientation) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
            ...
            public StreetViewPanoramaOrientation pointToOrientation(C0272d point) throws RemoteException {
            ...
            public void setOnStreetViewPanoramaCameraChangeListener(C0542r listener) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
            ...
            public void setOnStreetViewPanoramaChangeListener(C0543s listener) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
            ...
            public void setOnStreetViewPanoramaClickListener(C0544t listener) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
        ...
        public static IStreetViewPanoramaDelegate br(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IStreetViewPanoramaDelegate)) ? new C1107a(iBinder) : (IStreetViewPanoramaDelegate) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 15:
                    data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
                    setOnStreetViewPanoramaChangeListener(C1150a.bm(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 16:
                    data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
                    setOnStreetViewPanoramaCameraChangeListener(C1148a.bl(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 17:
                    data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
                    setOnStreetViewPanoramaClickListener(C1152a.bn(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 18:
                    data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
                    StreetViewPanoramaOrientation pointToOrientation = pointToOrientation(C0871a.ap(data.readStrongBinder()));
                    reply.writeNoException();
                ...
                case TimeUtils.HUNDRED_DAY_FIELD_LEN /*19*/:
                    data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
                    C0272d orientationToPoint = orientationToPoint(data.readInt() != 0 ? StreetViewPanoramaOrientation.CREATOR.dl(data) : null);
                    reply.writeNoException();
    ...
    C0272d orientationToPoint(StreetViewPanoramaOrientation streetViewPanoramaOrientation) throws RemoteException;

    StreetViewPanoramaOrientation pointToOrientation(C0272d c0272d) throws RemoteException;

    void setOnStreetViewPanoramaCameraChangeListener(C0542r c0542r) throws RemoteException;

    void setOnStreetViewPanoramaChangeListener(C0543s c0543s) throws RemoteException;

    void setOnStreetViewPanoramaClickListener(C0544t c0544t) throws RemoteException;
