...
public interface C0262l extends IInterface {

    /* renamed from: com.google.android.gms.drive.realtime.internal.l$a */
    public static abstract class C0855a extends Binder implements C0262l {

        /* renamed from: com.google.android.gms.drive.realtime.internal.l$a$a */
        private static class C0854a implements C0262l {
            private IBinder le;
            ...
            /* renamed from: n */
            public void mo1085n(Status status) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.drive.realtime.internal.IIntCallback");
        ...
        public static C0262l ak(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.drive.realtime.internal.IIntCallback");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0262l)) ? new C0854a(iBinder) : (C0262l) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 2:
                    data.enforceInterface("com.google.android.gms.drive.realtime.internal.IIntCallback");
                    mo1085n(data.readInt() != 0 ? Status.CREATOR.createFromParcel(data) : null);
                    reply.writeNoException();
                    return true;
                case 1598968902:
    ...
    /* renamed from: n */
    void mo1085n(Status status) throws RemoteException;
}
