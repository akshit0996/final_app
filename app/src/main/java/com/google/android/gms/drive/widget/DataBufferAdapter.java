...
public class DataBufferAdapter<T> extends BaseAdapter {
    ...
    /* renamed from: a */
    private View m500a(int i, View view, ViewGroup viewGroup, int i2) {
        ...
        try {
            ...
            C0218w.m392a("DataBufferAdapter", e, "You must supply a resource ID for a TextView");
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        return m500a(position, convertView, parent, this.Tp);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        return m500a(position, convertView, parent, this.To);
    }
