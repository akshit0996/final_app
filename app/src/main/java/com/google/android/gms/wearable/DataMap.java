...
public class DataMap {
    ...
    /* renamed from: a */
    private static void m2265a(Bundle bundle, String str, Object obj) {
    ...
    /* renamed from: a */
    private static void m2266a(DataMap dataMap, String str, Object obj) {
        if (obj instanceof String) {
    ...
    /* renamed from: a */
    private void m2267a(String str, Object obj, String str2, ClassCastException classCastException) {
        m2268a(str, obj, str2, "<null>", classCastException);
    }

    /* renamed from: a */
    private void m2268a(String str, Object obj, String str2, Object obj2, ClassCastException classCastException) {
    ...
    /* renamed from: a */
    private static boolean m2269a(Asset asset, Asset asset2) {
    ...
    /* renamed from: a */
    private static boolean m2270a(DataMap dataMap, DataMap dataMap2) {
        ...
        for (String str : dataMap.keySet()) {
            ...
            if (obj instanceof Asset) {
                ...
                if (!m2269a((Asset) obj, (Asset) obj2)) {
                    return false;
                }
            } else if (obj instanceof String[]) {
    ...
    /* renamed from: d */
    private static int m2271d(ArrayList<?> arrayList) {
    ...
    public static DataMap fromBundle(Bundle bundle) {
        ...
        for (String str : bundle.keySet()) {
            m2266a(dataMap, str, bundle.get(str));
        }
        return dataMap;
    }
    ...
    public static DataMap fromByteArray(byte[] bytes) {
        try {
            return ql.m1826a(new C0499a(qm.m4570n(bytes), new ArrayList()));
        } catch (Throwable e) {
    ...
    public boolean equals(Object o) {
        return !(o instanceof DataMap) ? false : m2270a(this, (DataMap) o);
    }
    ...
    public boolean getBoolean(String key, boolean defaultValue) {
        ...
        if (obj != null) {
            try {
                ...
                m2268a(key, obj, "Boolean", Boolean.valueOf(defaultValue), e);
            }
        }
        return defaultValue;
    }
    ...
    public byte getByte(String key, byte defaultValue) {
        ...
        if (obj != null) {
            try {
                ...
                m2268a(key, obj, "Byte", Byte.valueOf(defaultValue), e);
            }
        }
        return defaultValue;
    }
    ...
    public ArrayList<DataMap> getDataMapArrayList(String key) {
        ...
        try {
            ...
            m2267a(key, obj, "ArrayList<DataMap>", e);
            return null;
        }
    }
    ...
    public double getDouble(String key, double defaultValue) {
        ...
        if (obj != null) {
            try {
                ...
                m2268a(key, obj, "Double", Double.valueOf(defaultValue), e);
            }
        }
        return defaultValue;
    }
    ...
    public float getFloat(String key, float defaultValue) {
        ...
        if (obj != null) {
            try {
                ...
                m2268a(key, obj, "Float", Float.valueOf(defaultValue), e);
            }
        }
        return defaultValue;
    }
    ...
    public ArrayList<Integer> getIntegerArrayList(String key) {
        ...
        try {
            ...
            m2267a(key, obj, "ArrayList<Integer>", e);
            return null;
        }
    }
    ...
    public ArrayList<String> getStringArrayList(String key) {
        ...
        try {
            ...
            m2267a(key, obj, "ArrayList<String>", e);
            return null;
        }
    }
    ...
    public Bundle toBundle() {
        ...
        for (String str : this.axg.keySet()) {
            m2265a(bundle, str, this.axg.get(str));
        }
        return bundle;
    }

    public byte[] toByteArray() {
        return qw.m1906f(ql.m1824a(this).ayo);
    }
