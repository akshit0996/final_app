...
public final class AppContentCardEntity implements SafeParcelable, AppContentCard {
    ...
    /* renamed from: a */
    static int m4030a(AppContentCard appContentCard) {
    ...
    /* renamed from: a */
    static boolean m4031a(AppContentCard appContentCard, Object obj) {
    ...
    /* renamed from: b */
    static String m4032b(AppContentCard appContentCard) {
        return jv.m1571h(appContentCard).m1570a("Actions", appContentCard.getActions()).m1570a("Annotations", appContentCard.kN()).m1570a("Conditions", appContentCard.kH()).m1570a("ContentDescription", appContentCard.kI()).m1570a("CurrentSteps", Integer.valueOf(appContentCard.kO())).m1570a("Description", appContentCard.getDescription()).m1570a("ExtraData", appContentCard.kP()).m1570a("IconImageUri", appContentCard.getIconImageUri()).m1570a("ImageUri", appContentCard.kL()).m1570a("Subtitle", appContentCard.kQ()).m1570a("Title", appContentCard.getTitle()).m1570a("TotalSteps", Integer.valueOf(appContentCard.kR())).m1570a("Type", appContentCard.getType()).toString();
    }
    ...
    public void writeToParcel(Parcel out, int flags) {
        AppContentCardEntityCreator.m668a(this, out, flags);
    }
}
