...
public class CreateContentsRequest implements SafeParcelable {
    public static final Creator<CreateContentsRequest> CREATOR = new C0211h();
    final int CK;
    final int Oi;
    ...
    CreateContentsRequest(int versionCode, int mode) {
        ...
        jx.m1580b(z, (Object) "Cannot create a new read-only contents!");
        this.Oi = mode;
    }
