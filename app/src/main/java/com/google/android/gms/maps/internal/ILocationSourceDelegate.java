...
import com.google.android.gms.maps.internal.C0533i.C1130a;

public interface ILocationSourceDelegate extends IInterface {

    /* renamed from: com.google.android.gms.maps.internal.ILocationSourceDelegate$a */
    public static abstract class C1100a extends Binder implements ILocationSourceDelegate {

        /* renamed from: com.google.android.gms.maps.internal.ILocationSourceDelegate$a$a */
        private static class C1099a implements ILocationSourceDelegate {
            private IBinder le;
            ...
            public void activate(C0533i listener) throws RemoteException {
        ...
        public static ILocationSourceDelegate aW(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ILocationSourceDelegate)) ? new C1099a(iBinder) : (ILocationSourceDelegate) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    activate(C1130a.bc(data.readStrongBinder()));
    ...
    void activate(C0533i c0533i) throws RemoteException;
