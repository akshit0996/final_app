...
public final class fr {
    ...
    /* renamed from: a */
    public static fj m1225a(Context context, fh fhVar, String str) {
        try {
            fj fjVar;
            List list;
            List list2;
            ...
            if (TextUtils.isEmpty(optString4)) {
                if (TextUtils.isEmpty(optString2)) {
                    gr.m1341W("Could not parse the mediation config: Missing required ad_html or ad_url field.");
                    return new fj(0);
                }
                fj a = fq.m4377a(context, fhVar.lO.wS, optString2, null, null);
                optString = a.sg;
                optString4 = a.tU;
                j = a.ua;
                fjVar = a;
            } else if (TextUtils.isEmpty(optString)) {
                gr.m1341W("Could not parse the mediation config: Missing required ad_base_url field");
                return new fj(0);
            } else {
                fjVar = null;
            }
            ...
            return new fj(optString, optString4, list, list2, j2, false, -1, list3, -1, i, optString3, j, optString5, optBoolean, str2, optString7, false, false, fhVar.tT, false);
        } catch (JSONException e) {
            gr.m1341W("Could not parse the mediation config: " + e.getMessage());
            return new fj(0);
        }
    }

    /* renamed from: a */
    public static String m1226a(fh fhVar, fv fvVar, Location location, String str, String str2, String str3) {
        try {
            ...
            m1228a((HashMap) hashMap, fhVar.tL);
            ...
            m1230a((HashMap) hashMap, fvVar);
            if (fhVar.tL.versionCode >= 2 && fhVar.tL.ol != null) {
                m1227a((HashMap) hashMap, fhVar.tL.ol);
            }
            ...
            if (gr.m1346v(2)) {
                gr.m1340V("Ad Request JSON: " + gi.m1312t(hashMap).toString(2));
            }
            return gi.m1312t(hashMap).toString();
        } catch (JSONException e) {
            gr.m1341W("Problem serializing ad request to JSON: " + e.getMessage());
            return null;
        }
    }

    /* renamed from: a */
    private static void m1227a(HashMap<String, Object> hashMap, Location location) {
    ...
    /* renamed from: a */
    private static void m1228a(HashMap<String, Object> hashMap, av avVar) {
        String dr = ge.dr();
        if (dr != null) {
            hashMap.put("abf", dr);
        }
        ...
        if (avVar.versionCode >= 2) {
            ...
            if (avVar.ok != null) {
                m1229a((HashMap) hashMap, avVar.ok);
            }
        }
    ...
    /* renamed from: a */
    private static void m1229a(HashMap<String, Object> hashMap, bj bjVar) {
        Object obj;
        Object obj2 = null;
        if (Color.alpha(bjVar.oQ) != 0) {
            hashMap.put("acolor", m1232u(bjVar.oQ));
        }
        if (Color.alpha(bjVar.backgroundColor) != 0) {
            hashMap.put("bgcolor", m1232u(bjVar.backgroundColor));
        }
        if (!(Color.alpha(bjVar.oR) == 0 || Color.alpha(bjVar.oS) == 0)) {
            hashMap.put("gradientto", m1232u(bjVar.oR));
            hashMap.put("gradientfrom", m1232u(bjVar.oS));
        }
        if (Color.alpha(bjVar.oT) != 0) {
            hashMap.put("bcolor", m1232u(bjVar.oT));
        }
        ...
        if (Color.alpha(bjVar.oY) != 0) {
            hashMap.put("dcolor", m1232u(bjVar.oY));
        }
        if (bjVar.oZ != null) {
            hashMap.put("font", bjVar.oZ);
        }
        if (Color.alpha(bjVar.pa) != 0) {
            hashMap.put("hcolor", m1232u(bjVar.pa));
        }
    ...
    /* renamed from: a */
    private static void m1230a(HashMap<String, Object> hashMap, fv fvVar) {
        hashMap.put("am", Integer.valueOf(fvVar.vg));
        hashMap.put("cog", m1231u(fvVar.vh));
        hashMap.put("coh", m1231u(fvVar.vi));
        ...
        hashMap.put("ma", m1231u(fvVar.vm));
        hashMap.put("sp", m1231u(fvVar.vn));
    ...
    /* renamed from: u */
    private static Integer m1231u(boolean z) {
        return Integer.valueOf(z ? 1 : 0);
    }

    /* renamed from: u */
    private static String m1232u(int i) {
