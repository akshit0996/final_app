...
public class C0810a implements SafeParcelable {
    public static final Creator<C0810a> CREATOR = new C0172b();
    final int CK;
    final int Gt;
    ...
    C0810a(int i, ParcelFileDescriptor parcelFileDescriptor, int i2) {
        this.CK = i;
    ...
    /* renamed from: a */
    private void m2500a(Closeable closeable) {
        try {
            closeable.close();
        } catch (Throwable e) {
