...
public interface C0567l extends IInterface {
    ...
    public static abstract class C1175a extends Binder implements C0567l {

        /* renamed from: com.google.android.gms.maps.model.internal.l$a$a */
        private static class C1174a implements C0567l {
            private IBinder le;

            C1174a(IBinder iBinder) {
                this.le = iBinder;
            }
            ...
            /* renamed from: b */
            public void mo2410b(C1161a c1161a) throws RemoteException {
            ...
            /* renamed from: h */
            public boolean mo2417h(C0567l c0567l) throws RemoteException {
                boolean z = false;
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
            ...
            /* renamed from: n */
            public void mo2424n(C0272d c0272d) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IMarkerDelegate");
        ...
        public static C0567l bA(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.model.internal.IMarkerDelegate");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0567l)) ? new C1174a(iBinder) : (C0567l) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 16:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IMarkerDelegate");
                    isDraggable = mo2417h(C1175a.bA(data.readStrongBinder()));
                    reply.writeNoException();
                    if (isDraggable) {
                        i = 1;
                    }
                ...
                case 18:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IMarkerDelegate");
                    mo2424n(C0871a.ap(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
    ...
    /* renamed from: b */
    void mo2410b(C1161a c1161a) throws RemoteException;
    ...
    /* renamed from: h */
    boolean mo2417h(C0567l c0567l) throws RemoteException;
    ...
    /* renamed from: n */
    void mo2424n(C0272d c0272d) throws RemoteException;
