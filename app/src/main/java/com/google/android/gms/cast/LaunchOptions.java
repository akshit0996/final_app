...
public class LaunchOptions implements SafeParcelable {
    public static final Creator<LaunchOptions> CREATOR = new C0149c();
    ...
    public static final class Builder {
        ...
        public Builder setLocale(Locale locale) {
            this.FS.setLanguage(in.m1449b(locale));
            return this;
        }
    ...
    public LaunchOptions() {
        this(1, false, in.m1449b(Locale.getDefault()));
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.FQ == launchOptions.FQ && in.m1447a(this.FR, launchOptions.FR);
    }
