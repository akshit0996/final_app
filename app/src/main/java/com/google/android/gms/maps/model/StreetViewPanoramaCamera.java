...
public class StreetViewPanoramaCamera implements SafeParcelable {
    public static final C0579q CREATOR = new C0579q();
    ...
    StreetViewPanoramaCamera(int versionCode, float zoom, float tilt, float bearing) {
        ...
        jx.m1580b(z, (Object) "Tilt needs to be between -90 and 90 inclusive");
        this.CK = versionCode;
        if (((double) zoom) <= 0.0d) {
            zoom = 0.0f;
        }
    ...
    public String toString() {
        return jv.m1571h(this).m1570a("zoom", Float.valueOf(this.zoom)).m1570a("tilt", Float.valueOf(this.tilt)).m1570a("bearing", Float.valueOf(this.bearing)).toString();
    }

    public void writeToParcel(Parcel out, int flags) {
        C0579q.m2016a(this, out, flags);
    }
}
