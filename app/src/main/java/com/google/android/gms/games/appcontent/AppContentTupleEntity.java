...
public final class AppContentTupleEntity implements SafeParcelable, AppContentTuple {
    ...
    /* renamed from: a */
    static int m4039a(AppContentTuple appContentTuple) {
        return jv.hashCode(appContentTuple.getName(), appContentTuple.getValue());
    }

    /* renamed from: a */
    static boolean m4040a(AppContentTuple appContentTuple, Object obj) {
    ...
    /* renamed from: b */
    static String m4041b(AppContentTuple appContentTuple) {
        return jv.m1571h(appContentTuple).m1570a("Name", appContentTuple.getName()).m1570a("Value", appContentTuple.getValue()).toString();
    }
    ...
    public void writeToParcel(Parcel out, int flags) {
        AppContentTupleEntityCreator.m671a(this, out, flags);
    }
}
