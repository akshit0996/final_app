...
public interface bc extends IInterface {
    ...
    public static abstract class C0904a extends Binder implements bc {

        /* renamed from: com.google.android.gms.internal.bc$a$a */
        private static class C0903a implements bc {
            private IBinder le;
        ...
        /* renamed from: e */
        public static bc m3053e(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.client.IAdListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof bc)) ? new C0903a(iBinder) : (bc) queryLocalInterface;
        }
