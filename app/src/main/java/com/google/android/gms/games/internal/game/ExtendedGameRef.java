...
public class ExtendedGameRef extends C0174d implements ExtendedGame {
    ...
    public boolean equals(Object obj) {
        return ExtendedGameEntity.m4884a(this, obj);
    }
    ...
    public int hashCode() {
        return ExtendedGameEntity.m4883a(this);
    }

    public ArrayList<GameBadge> lY() {
        int i = 0;
        if (this.JG.m2493c("badge_title", this.KZ, this.JG.au(this.KZ)) == null) {
    ...
    public String toString() {
        return ExtendedGameEntity.m4885b((ExtendedGame) this);
    }
