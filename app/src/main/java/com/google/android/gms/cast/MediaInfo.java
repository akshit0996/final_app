...
public final class MediaInfo {
    ...
    MediaInfo(JSONObject json) throws JSONException {
        ...
        if (json.has("textTrackStyle")) {
            ...
            textTrackStyle.m113c(jSONObject2);
    ...
    /* renamed from: a */
    void m101a(MediaMetadata mediaMetadata) {
        this.FW = mediaMetadata;
    }

    /* renamed from: d */
    void m102d(List<MediaTrack> list) {
        this.FY = list;
    }
    ...
    public boolean equals(Object other) {
        ...
        if (this.Ga != null && mediaInfo.Ga != null && !li.m1644d(this.Ga, mediaInfo.Ga)) {
            return false;
        }
        if (!(in.m1447a(this.FT, mediaInfo.FT) && this.FU == mediaInfo.FU && in.m1447a(this.FV, mediaInfo.FV) && in.m1447a(this.FW, mediaInfo.FW) && this.FX == mediaInfo.FX)) {
            z = false;
        }
        return z;
    }
    ...
    /* renamed from: m */
    void m103m(long j) throws IllegalArgumentException {
        if (j < 0) {
    ...
    public JSONObject toJson() {
        ...
        try {
            ...
            jSONObject.put("duration", in.m1450o(this.FX));
            if (this.FY != null) {
