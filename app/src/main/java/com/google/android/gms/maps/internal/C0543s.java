...
public interface C0543s extends IInterface {

    /* renamed from: com.google.android.gms.maps.internal.s$a */
    public static abstract class C1150a extends Binder implements C0543s {

        /* renamed from: com.google.android.gms.maps.internal.s$a$a */
        private static class C1149a implements C0543s {
            private IBinder le;
        ...
        public static C0543s bm(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0543s)) ? new C1149a(iBinder) : (C0543s) queryLocalInterface;
        }
