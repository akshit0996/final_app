...
public interface HistoryApi {
    ...
    public static class ViewIntentBuilder {
        ...
        /* renamed from: i */
        private Intent m515i(Intent intent) {
            if (this.TP == null) {
                return intent;
            }
        ...
        public Intent build() {
            boolean z = true;
            jx.m1576a(this.LW > 0, "Start time must be set");
            if (this.TO <= this.LW) {
                z = false;
            }
            jx.m1576a(z, "End time must be set and after start time");
            ...
            C0187c.m273a(this.TN, intent, DataSource.EXTRA_DATA_SOURCE);
            return m515i(intent);
        }

        public ViewIntentBuilder setDataSource(DataSource dataSource) {
            jx.m1581b(dataSource.getDataType().equals(this.TM), "Data source %s is not for the data type %s", dataSource, this.TM);
            this.TN = dataSource;
            return this;
        }
