...
public final class DataType implements SafeParcelable {
    ...
    public static final Creator<DataType> CREATOR = new C0288h();
    ...
    private static final Map<DataType, List<DataType>> Us = new C02781();
    ...
    static class C02781 extends HashMap<DataType, List<DataType>> {
        C02781() {
    ...
    public DataType(String name, Field... fields) {
        this(1, name, la.m1632b(fields));
    }

    /* renamed from: a */
    private boolean m2680a(DataType dataType) {
    ...
    public boolean equals(Object that) {
        return this == that || ((that instanceof DataType) && m2680a((DataType) that));
    }
