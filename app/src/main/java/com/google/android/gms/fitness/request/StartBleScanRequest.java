...
public class StartBleScanRequest implements SafeParcelable {
    ...
    public static class Builder {
        ...
        /* renamed from: a */
        public Builder m610a(C0325l c0325l) {
            this.Wm = c0325l;
            return this;
        }

        public StartBleScanRequest build() {
            jx.m1576a(this.Wm != null, "Must set BleScanCallback");
            return new StartBleScanRequest();
        }

        public Builder setBleScanCallback(BleScanCallback bleScanCallback) {
            m610a(C0311a.jP().m611a(bleScanCallback));
            return this;
        }
        ...
        public Builder setTimeoutSecs(int stopTimeSecs) {
            boolean z = true;
            jx.m1580b(stopTimeSecs > 0, (Object) "Stop time must be greater than zero");
            if (stopTimeSecs > 60) {
                z = false;
            }
            jx.m1580b(z, (Object) "Stop time must be less than 1 minute");
    ...
    StartBleScanRequest(int versionCode, List<DataType> dataTypes, IBinder bleScanCallback, int timeoutSecs) {
        this.CK = versionCode;
        this.TY = dataTypes;
        this.Wm = C0881a.aB(bleScanCallback);
        this.Wn = timeoutSecs;
    }
    ...
    public String toString() {
        return jv.m1571h(this).m1570a("dataTypes", this.TY).m1570a("timeoutSecs", Integer.valueOf(this.Wn)).toString();
    }

    public void writeToParcel(Parcel parcel, int flags) {
        ac.m614a(this, parcel, flags);
    }
}
