...
public class StreetViewPanoramaLink implements SafeParcelable {
    public static final C0580r CREATOR = new C0580r();
    ...
    public String toString() {
        return jv.m1571h(this).m1570a("panoId", this.panoId).m1570a("bearing", Float.valueOf(this.bearing)).toString();
    }

    public void writeToParcel(Parcel out, int flags) {
        C0580r.m2017a(this, out, flags);
    }
}
