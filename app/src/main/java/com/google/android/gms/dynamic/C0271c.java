...
public interface C0271c extends IInterface {

    /* renamed from: com.google.android.gms.dynamic.c$a */
    public static abstract class C0869a extends Binder implements C0271c {

        /* renamed from: com.google.android.gms.dynamic.c$a$a */
        private static class C0868a implements C0271c {
            private IBinder le;
            ...
            /* renamed from: d */
            public void mo1134d(C0272d c0272d) throws RemoteException {
            ...
            /* renamed from: e */
            public void mo1135e(C0272d c0272d) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.dynamic.IFragmentWrapper");
            ...
            public C0272d jf() throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.dynamic.IFragmentWrapper");
            ...
            public C0271c jg() throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.dynamic.IFragmentWrapper");
                    ...
                    obtain2.readException();
                    C0271c ao = C0869a.ao(obtain2.readStrongBinder());
                    return ao;
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public C0272d jh() throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.dynamic.IFragmentWrapper");
            ...
            public C0271c ji() throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.dynamic.IFragmentWrapper");
        ...
        public static C0271c ao(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.dynamic.IFragmentWrapper");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0271c)) ? new C0868a(iBinder) : (C0271c) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 20:
                    data.enforceInterface("com.google.android.gms.dynamic.IFragmentWrapper");
                    mo1134d(C0871a.ap(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 21:
                    data.enforceInterface("com.google.android.gms.dynamic.IFragmentWrapper");
                ...
                case 27:
                    data.enforceInterface("com.google.android.gms.dynamic.IFragmentWrapper");
                    mo1135e(C0871a.ap(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 1598968902:
    ...
    /* renamed from: d */
    void mo1134d(C0272d c0272d) throws RemoteException;

    /* renamed from: e */
    void mo1135e(C0272d c0272d) throws RemoteException;
    ...
    C0272d jf() throws RemoteException;

    C0271c jg() throws RemoteException;

    C0272d jh() throws RemoteException;

    C0271c ji() throws RemoteException;
