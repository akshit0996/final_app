...
public final class Field implements SafeParcelable {
    public static final Creator<Field> CREATOR = new C0290j();
    ...
    Field(int versionCode, String name, int format) {
        this.CK = versionCode;
        this.mName = (String) jx.m1582i(name);
        this.UE = format;
    }
    ...
    /* renamed from: a */
    private boolean m2688a(Field field) {
    ...
    public boolean equals(Object that) {
        return this == that || ((that instanceof Field) && m2688a((Field) that));
    }
