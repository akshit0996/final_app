...
public final class ParticipantEntity extends GamesDowngradeableSafeParcel implements Participant {
    ...
    static final class ParticipantEntityCreatorCompat extends ParticipantEntityCreator {
        ...
        public ParticipantEntity cA(Parcel parcel) {
            Object obj = 1;
            if (GamesDowngradeableSafeParcel.m4233c(ji.ht()) || ji.aW(ParticipantEntity.class.getCanonicalName())) {
    ...
    /* renamed from: a */
    static int m4899a(Participant participant) {
    ...
    /* renamed from: a */
    static boolean m4900a(Participant participant, Object obj) {
    ...
    /* renamed from: b */
    static String m4901b(Participant participant) {
        return jv.m1571h(participant).m1570a("ParticipantId", participant.getParticipantId()).m1570a("Player", participant.getPlayer()).m1570a("Status", Integer.valueOf(participant.getStatus())).m1570a("ClientAddress", participant.le()).m1570a("ConnectedToRoom", Boolean.valueOf(participant.isConnectedToRoom())).m1570a("DisplayName", participant.getDisplayName()).m1570a("IconImage", participant.getIconImageUri()).m1570a("IconImageUrl", participant.getIconImageUrl()).m1570a("HiResImage", participant.getHiResImageUri()).m1570a("HiResImageUrl", participant.getHiResImageUrl()).m1570a("Capabilities", Integer.valueOf(participant.getCapabilities())).m1570a("Result", participant.getResult()).toString();
    }
    ...
    public String toString() {
        return m4901b((Participant) this);
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        ParticipantEntityCreator.m957a(this, dest, flags);
    }
}
