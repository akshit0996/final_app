...
public interface eq extends IInterface {
    ...
    public static abstract class C0950a extends Binder implements eq {

        /* renamed from: com.google.android.gms.internal.eq$a$a */
        private static class C0949a implements eq {
            private IBinder le;
        ...
        /* renamed from: y */
        public static eq m3137y(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof eq)) ? new C0949a(iBinder) : (eq) queryLocalInterface;
        }
