...
public interface oj extends IInterface {
    ...
    public static abstract class C1057a extends Binder implements oj {

        /* renamed from: com.google.android.gms.internal.oj$a$a */
        private static class C1056a implements oj {
            private IBinder le;

            C1056a(IBinder iBinder) {
                this.le = iBinder;
            }
        ...
        public static oj bF(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof oj)) ? new C1056a(iBinder) : (oj) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    mo2047a(data.readInt(), data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null, data.readInt(), data.readInt() != 0 ? (Intent) Intent.CREATOR.createFromParcel(data) : null);
    ...
    /* renamed from: a */
    void mo2047a(int i, Bundle bundle, int i2, Intent intent) throws RemoteException;
}
