...
public class oh implements SafeParcelable {
    ...
    public String toString() {
        return jv.m1571h(this).m1570a("clientPackageName", this.akg).m1570a("locale", this.akh).m1570a("accountName", this.aki).m1570a("gCoreClientName", this.akj).toString();
    }

    public void writeToParcel(Parcel out, int flags) {
        oi oiVar = CREATOR;
        oi.m1758a(this, out, flags);
    }
}
