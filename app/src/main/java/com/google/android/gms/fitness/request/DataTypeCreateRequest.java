...
public class DataTypeCreateRequest implements SafeParcelable {
    public static final Creator<DataTypeCreateRequest> CREATOR = new C0323i();
    ...
    public static class Builder {
        ...
        public Builder addField(String name, int format) {
            ...
            jx.m1580b(z, (Object) "Invalid name specified");
            return addField(new Field(name, format));
        }

        public DataTypeCreateRequest build() {
            boolean z = true;
            jx.m1576a(this.mName != null, "Must set the name");
            if (this.Uv.isEmpty()) {
                z = false;
            }
            jx.m1576a(z, "Must specify the data fields");
    ...
    /* renamed from: a */
    private boolean m2700a(DataTypeCreateRequest dataTypeCreateRequest) {
    ...
    public boolean equals(Object o) {
        return o == this || ((o instanceof DataTypeCreateRequest) && m2700a((DataTypeCreateRequest) o));
    }
    ...
    public String toString() {
        return jv.m1571h(this).m1570a("name", this.mName).m1570a("fields", this.Uv).toString();
    }

    public void writeToParcel(Parcel dest, int flags) {
        C0323i.m633a(this, dest, flags);
    }
}
