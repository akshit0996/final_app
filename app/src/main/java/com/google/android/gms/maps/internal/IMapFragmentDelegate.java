...
public interface IMapFragmentDelegate extends IInterface {
    ...
    public static abstract class C1102a extends Binder implements IMapFragmentDelegate {

        /* renamed from: com.google.android.gms.maps.internal.IMapFragmentDelegate$a$a */
        private static class C1101a implements IMapFragmentDelegate {
            private IBinder le;

            C1101a(IBinder iBinder) {
                this.le = iBinder;
            }
            ...
            public IGoogleMapDelegate getMap() throws RemoteException {
                ...
                try {
                    ...
                    IGoogleMapDelegate aT = C1098a.aT(obtain2.readStrongBinder());
                    return aT;
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void getMapAsync(C0537m callback) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IMapFragmentDelegate");
            ...
            public C0272d onCreateView(C0272d inflaterWrapper, C0272d containerWrapper, Bundle savedInstanceState) throws RemoteException {
            ...
            public void onInflate(C0272d activityWrapper, GoogleMapOptions options, Bundle savedInstanceState) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IMapFragmentDelegate");
        ...
        public static IMapFragmentDelegate aX(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IMapFragmentDelegate)) ? new C1101a(iBinder) : (IMapFragmentDelegate) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 2:
                    data.enforceInterface("com.google.android.gms.maps.internal.IMapFragmentDelegate");
                    onInflate(C0871a.ap(data.readStrongBinder()), data.readInt() != 0 ? GoogleMapOptions.CREATOR.cX(data) : null, data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null);
                    reply.writeNoException();
                    return true;
                case 3:
                    data.enforceInterface("com.google.android.gms.maps.internal.IMapFragmentDelegate");
                ...
                case 4:
                    data.enforceInterface("com.google.android.gms.maps.internal.IMapFragmentDelegate");
                    C0272d onCreateView = onCreateView(C0871a.ap(data.readStrongBinder()), C0871a.ap(data.readStrongBinder()), data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null);
                    reply.writeNoException();
                ...
                case 12:
                    data.enforceInterface("com.google.android.gms.maps.internal.IMapFragmentDelegate");
                    getMapAsync(C1138a.bg(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 1598968902:
    ...
    void getMapAsync(C0537m c0537m) throws RemoteException;

    boolean isReady() throws RemoteException;

    void onCreate(Bundle bundle) throws RemoteException;

    C0272d onCreateView(C0272d c0272d, C0272d c0272d2, Bundle bundle) throws RemoteException;

    void onDestroy() throws RemoteException;

    void onDestroyView() throws RemoteException;

    void onInflate(C0272d c0272d, GoogleMapOptions googleMapOptions, Bundle bundle) throws RemoteException;
