...
public class SessionReadRequest implements SafeParcelable {
    public static final Creator<SessionReadRequest> CREATOR = new C0332t();
    ...
    public static class Builder {
        ...
        public SessionReadRequest build() {
            jx.m1581b(this.LW > 0, "Invalid start time: %s", Long.valueOf(this.LW));
            boolean z = this.TO > 0 && this.TO > this.LW;
            jx.m1581b(z, "Invalid end time: %s", Long.valueOf(this.TO));
        ...
        public Builder excludePackage(String appPackageName) {
            jx.m1578b((Object) appPackageName, (Object) "Attempting to use a null package name");
    ...
    /* renamed from: a */
    private boolean m2702a(SessionReadRequest sessionReadRequest) {
    ...
    public boolean equals(Object o) {
        return this == o || ((o instanceof SessionReadRequest) && m2702a((SessionReadRequest) o));
    }
    ...
    public String toString() {
        return jv.m1571h(this).m1570a("sessionName", this.Wj).m1570a("sessionId", this.vZ).m1570a("startTimeMillis", Long.valueOf(this.LW)).m1570a("endTimeMillis", Long.valueOf(this.TO)).m1570a("dataTypes", this.TY).m1570a("dataSources", this.VH).m1570a("sessionsFromAllApps", Boolean.valueOf(this.Wk)).m1570a("excludedPackages", this.Wl).m1570a("useServer", Boolean.valueOf(this.VR)).toString();
    }

    public void writeToParcel(Parcel dest, int flags) {
        C0332t.m641a(this, dest, flags);
    }
}
