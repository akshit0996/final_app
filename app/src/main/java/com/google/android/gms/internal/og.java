...
public interface og extends IInterface {
    ...
    public static abstract class C1055a extends Binder implements og {

        /* renamed from: com.google.android.gms.internal.og$a$a */
        private static class C1054a implements og {
            private IBinder le;
            ...
            /* renamed from: X */
            public void mo2044X(DataHolder dataHolder) throws RemoteException {
            ...
            /* renamed from: Y */
            public void mo2045Y(DataHolder dataHolder) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.location.places.internal.IPlacesCallbacks");
                    if (dataHolder != null) {
            ...
            /* renamed from: Z */
            public void mo2046Z(DataHolder dataHolder) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.location.places.internal.IPlacesCallbacks");
                    if (dataHolder != null) {
        ...
        public static og aP(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof og)) ? new C1054a(iBinder) : (og) queryLocalInterface;
        }
    ...
    /* renamed from: X */
    void mo2044X(DataHolder dataHolder) throws RemoteException;

    /* renamed from: Y */
    void mo2045Y(DataHolder dataHolder) throws RemoteException;

    /* renamed from: Z */
    void mo2046Z(DataHolder dataHolder) throws RemoteException;
}
