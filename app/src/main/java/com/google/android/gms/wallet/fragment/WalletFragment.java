...
import com.google.android.gms.dynamic.C1331b;
...
public final class WalletFragment extends Fragment {
    ...
    private Boolean awi;
    private C1250b awn;
    private final C1331b awo = C1331b.m4009a(this);
    private final C1251c awp = new C1251c();
    private C1476a awq = new C1476a(this);
    ...
    private static class C1250b implements LifecycleDelegate {
        private final qa awl;

        private C1250b(qa qaVar) {
            this.awl = qaVar;
        }
    ...
    private class C1251c extends C0270a<C1250b> implements OnClickListener {
        final /* synthetic */ WalletFragment awt;

        private C1251c(WalletFragment walletFragment) {
        ...
        /* renamed from: a */
        protected void mo2135a(C0273f<C1250b> c0273f) {
            Activity activity = this.awt.TG.getActivity();
            if (this.awt.awn == null && this.awt.mCreated && activity != null) {
                try {
                    this.awt.awn = new C1250b(qi.m3534a(activity, this.awt.awo, this.awt.awe, this.awt.awq));
                    this.awt.awe = null;
                    c0273f.mo1131a(this.awt.awn);
    ...
    static class C1476a extends C1066a {
        private OnStateChangedListener awr;
        private final WalletFragment aws;

        C1476a(WalletFragment walletFragment) {
        ...
        /* renamed from: a */
        public void m4707a(OnStateChangedListener onStateChangedListener) {
