...
public final class TextTrackStyle {
    ...
    /* renamed from: c */
    public void m113c(JSONObject jSONObject) throws JSONException {
        String string;
        clear();
    ...
    public boolean equals(Object other) {
        ...
        if (this.Ga != null && textTrackStyle.Ga != null && !li.m1644d(this.Ga, textTrackStyle.Ga)) {
            return false;
        }
        if (!(this.GT == textTrackStyle.GT && this.GU == textTrackStyle.GU && this.xB == textTrackStyle.xB && this.GV == textTrackStyle.GV && this.GW == textTrackStyle.GW && this.GX == textTrackStyle.GX && this.GZ == textTrackStyle.GZ && in.m1447a(this.Ha, textTrackStyle.Ha) && this.Hb == textTrackStyle.Hb && this.Hc == textTrackStyle.Hc)) {
            z = false;
        }
        return z;
    }
    ...
    public JSONObject toJson() {
        ...
        try {
            ...
            if (this.GU != 0) {
                jSONObject.put("foregroundColor", m112u(this.GU));
            }
            if (this.xB != 0) {
                jSONObject.put("backgroundColor", m112u(this.xB));
            }
            switch (this.GV) {
                case 0:
            ...
            if (this.GW != 0) {
                jSONObject.put("edgeColor", m112u(this.GW));
            }
            switch (this.GX) {
                case 0:
            ...
            if (this.GY != 0) {
                jSONObject.put("windowColor", m112u(this.GY));
            }
            if (this.GX == 2) {
