...
public final class ExtendedGameEntity extends GamesDowngradeableSafeParcel implements ExtendedGame {
    ...
    static final class ExtendedGameEntityCreatorCompat extends ExtendedGameEntityCreator {
        ...
        public ExtendedGameEntity cu(Parcel parcel) {
            if (GamesDowngradeableSafeParcel.m4233c(ji.ht()) || ji.aW(ExtendedGameEntity.class.getCanonicalName())) {
    ...
    /* renamed from: a */
    static int m4883a(ExtendedGame extendedGame) {
    ...
    /* renamed from: a */
    static boolean m4884a(ExtendedGame extendedGame, Object obj) {
    ...
    /* renamed from: b */
    static String m4885b(ExtendedGame extendedGame) {
        return jv.m1571h(extendedGame).m1570a("Game", extendedGame.getGame()).m1570a("Availability", Integer.valueOf(extendedGame.lZ())).m1570a("Owned", Boolean.valueOf(extendedGame.ma())).m1570a("AchievementUnlockedCount", Integer.valueOf(extendedGame.mb())).m1570a("LastPlayedServerTimestamp", Long.valueOf(extendedGame.mc())).m1570a("PriceMicros", Long.valueOf(extendedGame.md())).m1570a("FormattedPrice", extendedGame.me()).m1570a("FullPriceMicros", Long.valueOf(extendedGame.mf())).m1570a("FormattedFullPrice", extendedGame.mg()).m1570a("Snapshot", extendedGame.mh()).toString();
    }
    ...
    public String toString() {
        return m4885b((ExtendedGame) this);
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        ExtendedGameEntityCreator.m948a(this, dest, flags);
    }
}
