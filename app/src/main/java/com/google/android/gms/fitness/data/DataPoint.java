...
public final class DataPoint implements SafeParcelable {
    public static final Creator<DataPoint> CREATOR = new C0285e();
    ...
    private DataPoint(DataSource dataSource) {
        this.CK = 4;
        this.TN = (DataSource) jx.m1578b((Object) dataSource, (Object) "Data source cannot be null");
    ...
    DataPoint(List<DataSource> dataSources, RawDataPoint rawDataPoint) {
        this(4, m2673c(dataSources, rawDataPoint.UJ), rawDataPoint.Ud, rawDataPoint.Ue, rawDataPoint.Uf, m2673c(dataSources, rawDataPoint.UK), rawDataPoint.Uh, rawDataPoint.Ui);
    }

    /* renamed from: a */
    private boolean m2672a(DataPoint dataPoint) {
    ...
    /* renamed from: c */
    private static DataSource m2673c(List<DataSource> list, int i) {
        return (i < 0 || i >= list.size()) ? null : (DataSource) list.get(i);
    }

    private void cL(int i) {
        jx.m1581b(i == getDataType().getFields().size(), "Attempting to insert %s values, but needed %s: %s", Integer.valueOf(i), Integer.valueOf(getDataType().getFields().size()), getDataType().getFields());
    }
    ...
    public static DataPoint extract(Intent intent) {
        return intent == null ? null : (DataPoint) C0187c.m271a(intent, "com.google.android.gms.fitness.EXTRA_DATA_POINT", CREATOR);
    }
    ...
    public boolean equals(Object o) {
        return this == o || ((o instanceof DataPoint) && m2672a((DataPoint) o));
    }
    ...
    public DataPoint setTimestamp(long timestamp, TimeUnit timeUnit) {
        ...
        if (jq() && lt.m1650a(timeUnit)) {
            Log.w("Fitness", "Storing location at more than millisecond granularity is not supported. Extra precision is lost as the value is converted to milliseconds.");
            this.Ud = lt.m1649a(this.Ud, TimeUnit.NANOSECONDS, TimeUnit.MILLISECONDS);
        }
        return this;
    }
    ...
    public void writeToParcel(Parcel parcel, int flags) {
        C0285e.m541a(this, parcel, flags);
    }
}
