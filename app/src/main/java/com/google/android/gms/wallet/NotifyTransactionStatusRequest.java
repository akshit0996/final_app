...
public final class NotifyTransactionStatusRequest implements SafeParcelable {
    public static final Creator<NotifyTransactionStatusRequest> CREATOR = new C0677m();
    final int CK;
    String auL;
    String avL;
    int status;
    ...
    public final class Builder {
        ...
        public NotifyTransactionStatusRequest build() {
            boolean z = true;
            jx.m1580b(!TextUtils.isEmpty(this.avM.auL), (Object) "googleTransactionId is required");
            if (this.avM.status < 1 || this.avM.status > 8) {
                z = false;
            }
            jx.m1580b(z, (Object) "status is an unrecognized value");
            return this.avM;
        }
