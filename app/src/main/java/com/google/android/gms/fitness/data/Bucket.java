...
public class Bucket implements SafeParcelable {
    public static final Creator<Bucket> CREATOR = new C0284d();
    ...
    public Bucket(RawBucket bucket, List<DataSource> uniqueDataSources, List<DataType> uniqueDataTypes) {
        this(2, bucket.LW, bucket.TO, bucket.TQ, bucket.UI, m2669a(bucket.Ua, uniqueDataSources, uniqueDataTypes), bucket.Ub, bucket.Uc);
    }

    /* renamed from: a */
    private static List<DataSet> m2669a(List<RawDataSet> list, List<DataSource> list2, List<DataType> list3) {
    ...
    /* renamed from: a */
    private boolean m2670a(Bucket bucket) {
    ...
    /* renamed from: b */
    public boolean m2671b(Bucket bucket) {
    ...
    public boolean equals(Object o) {
        return o == this || ((o instanceof Bucket) && m2670a((Bucket) o));
    }
    ...
    public String toString() {
        return jv.m1571h(this).m1570a("startTime", Long.valueOf(this.LW)).m1570a("endTime", Long.valueOf(this.TO)).m1570a("activity", Integer.valueOf(this.TZ)).m1570a("dataSets", this.Ua).m1570a("bucketType", cJ(this.Ub)).m1570a("serverHasMoreData", Boolean.valueOf(this.Uc)).toString();
    }

    public void writeToParcel(Parcel dest, int flags) {
        C0284d.m540a(this, dest, flags);
    }
}
