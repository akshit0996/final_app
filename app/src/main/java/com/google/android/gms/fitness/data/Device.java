...
public final class Device implements SafeParcelable {
    public static final Creator<Device> CREATOR = new C0289i();
    ...
    Device(int versionCode, String manufacturer, String model, String version, String uid, int type, int platformType) {
        this.CK = versionCode;
        this.Uw = (String) jx.m1582i(manufacturer);
        this.Ux = (String) jx.m1582i(model);
        this.TU = "";
        this.Uy = (String) jx.m1582i(uid);
        this.Gt = type;
    ...
    /* renamed from: M */
    private static String m2681M(Context context) {
        return Secure.getString(context.getContentResolver(), "android_id");
    }

    /* renamed from: N */
    private static int m2682N(Context context) {
        switch (m2684P(context)) {
            case 8:
            case 9:
                return 0;
            case 10:
                return m2683O(context) ? 3 : 0;
            default:
                return m2686R(context) ? 1 : 2;
        }
    }

    /* renamed from: O */
    public static boolean m2683O(Context context) {
        return (context.getResources().getConfiguration().uiMode & 15) == 6;
    }

    /* renamed from: P */
    private static int m2684P(Context context) {
        return ((m2685Q(context) % 1000) / 100) + 5;
    }

    /* renamed from: Q */
    private static int m2685Q(Context context) {
        try {
    ...
    /* renamed from: R */
    private static boolean m2686R(Context context) {
        return ((TelephonyManager) context.getSystemService("phone")).getPhoneType() != 0;
    }

    /* renamed from: a */
    private boolean m2687a(Device device) {
    ...
    public static Device getLocalDevice(Context context) {
        int N = m2682N(context);
        return new Device(Build.MANUFACTURER, Build.MODEL, VERSION.RELEASE, m2681M(context), N, 2);
    }
    ...
    public boolean equals(Object that) {
        return this == that || ((that instanceof Device) && m2687a((Device) that));
    }
    ...
    public void writeToParcel(Parcel parcel, int flags) {
        C0289i.m545a(this, parcel, flags);
    }
}
