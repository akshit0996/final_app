...
public final class cr {
    ...
    public cr(String str) throws JSONException {
        ...
        if (gr.m1346v(2)) {
            gr.m1340V("Mediation Response JSON: " + jSONObject.toString(2));
        }
        ...
        if (optJSONObject != null) {
            ...
            this.qw = cw.m1105a(optJSONObject, "click_urls");
            this.qx = cw.m1105a(optJSONObject, "imp_urls");
            this.qy = cw.m1105a(optJSONObject, "nofill_urls");
    ...
    /* renamed from: a */
    private boolean m1103a(cq cqVar) {
