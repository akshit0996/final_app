...
public class LogicalFilter extends AbstractFilter {
    public static final Creator<LogicalFilter> CREATOR = new C0237i();
    final int CK;
    ...
    public <T> T mo3685a(C0234f<T> c0234f) {
        ...
        for (FilterHolder filter : this.Su) {
            arrayList.add(filter.getFilter().mo3685a(c0234f));
        }
        return c0234f.mo1063b(this.Sh, arrayList);
    }
