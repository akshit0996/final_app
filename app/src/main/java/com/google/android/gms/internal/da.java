...
public interface da extends IInterface {
    ...
    public static abstract class C0933a extends Binder implements da {

        /* renamed from: com.google.android.gms.internal.da$a$a */
        private static class C0932a implements da {
            private IBinder le;
        ...
        /* renamed from: p */
        public static da m3107p(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.mediation.client.IMediationAdapterListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof da)) ? new C0932a(iBinder) : (da) queryLocalInterface;
        }
