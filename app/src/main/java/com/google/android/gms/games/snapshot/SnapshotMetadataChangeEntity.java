...
public final class SnapshotMetadataChangeEntity extends SnapshotMetadataChange implements SafeParcelable {
    ...
    SnapshotMetadataChangeEntity(int versionCode, String description, Long playedTimeMillis, C0810a coverImage, Uri coverImageUri) {
        boolean z = true;
        this.CK = versionCode;
        this.UO = description;
        ...
        if (this.aff != null) {
            ...
            jx.m1576a(z, "Cannot set both a URI and an image");
    ...
    SnapshotMetadataChangeEntity(String description, Long playedTimeMillis, C0810a coverImage, Uri coverImageUri) {
    ...
    public void writeToParcel(Parcel out, int flags) {
        SnapshotMetadataChangeCreator.m967a(this, out, flags);
    }
}
