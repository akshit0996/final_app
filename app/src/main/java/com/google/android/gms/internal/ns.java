...
public final class ns implements SafeParcelable {
    ...
    public String toString() {
        return jv.m1571h(this).m1570a("transitionTypes", Integer.valueOf(this.agd)).m1570a("loiteringTimeMillis", Integer.valueOf(this.ahp)).m1570a("placeFilter", this.ahq).toString();
    }

    public void writeToParcel(Parcel parcel, int flags) {
        nt ntVar = CREATOR;
        nt.m1745a(this, parcel, flags);
    }
}
