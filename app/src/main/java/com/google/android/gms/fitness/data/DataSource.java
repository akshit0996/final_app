...
public class DataSource implements SafeParcelable {
    public static final Creator<DataSource> CREATOR = new C0287g();
    ...
    public static final class Builder {
        ...
        public DataSource build() {
            boolean z = true;
            jx.m1576a(this.TM != null, "Must set data type");
            if (this.Gt < 0) {
                z = false;
            }
            jx.m1576a(z, "Must set data source type");
        ...
        public Builder setAppPackageName(String packageName) {
            this.Um = new C0873a(packageName, null, null);
            return this;
        }
        ...
        public Builder setStreamName(String streamName) {
            jx.m1580b(streamName != null, (Object) "Must specify a valid stream name");
            this.Un = streamName;
            return this;
        }
    ...
    DataSource(int versionCode, DataType dataType, String name, int type, Device device, C0873a application, String streamName, boolean isObfuscated) {
        this.CK = versionCode;
        this.TM = dataType;
        this.Gt = type;
        this.mName = name;
    ...
    /* renamed from: a */
    private boolean m2679a(DataSource dataSource) {
        return this.Up.equals(dataSource.Up);
    }

    public static DataSource extract(Intent intent) {
        return intent == null ? null : (DataSource) C0187c.m271a(intent, EXTRA_DATA_SOURCE, CREATOR);
    }
    ...
    public boolean equals(Object that) {
        return this == that || ((that instanceof DataSource) && m2679a((DataSource) that));
    }
    ...
    public String toDebugString() {
        ...
        String str = this.Um == null ? "" : this.Um.equals(C0873a.TT) ? ":gms" : ":" + this.Um.getPackageName();
    ...
    public void writeToParcel(Parcel parcel, int flags) {
        C0287g.m543a(mg.m1685c(this), parcel, flags);
    }
}
