...
public final class WebImage implements SafeParcelable {
    public static final Creator<WebImage> CREATOR = new C0183b();
    ...
    public WebImage(JSONObject json) throws IllegalArgumentException {
        this(m2505d(json), json.optInt("width", 0), json.optInt("height", 0));
    }

    /* renamed from: d */
    private static Uri m2505d(JSONObject jSONObject) {
        Uri uri = null;
