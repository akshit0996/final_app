...
public class CustomPropertyKey implements SafeParcelable {
    public static final Creator<CustomPropertyKey> CREATOR = new C0219c();
    ...
    CustomPropertyKey(int versionCode, String key, int visibility) {
        ...
        jx.m1580b(Rc.matcher(key).matches(), (Object) "key name characters must be alphanumeric or one of .!@$%^&*()-_/");
        if (!(visibility == 0 || visibility == 1)) {
            z = false;
        }
        jx.m1580b(z, (Object) "visibility must be either PUBLIC or PRIVATE");
        this.CK = versionCode;
        this.KP = key;
