...
public interface qb extends IInterface {
    ...
    public static abstract class C1066a extends Binder implements qb {

        /* renamed from: com.google.android.gms.internal.qb$a$a */
        private static class C1065a implements qb {
            private IBinder le;
            ...
            /* renamed from: a */
            public void mo2090a(int i, int i2, Bundle bundle) throws RemoteException {
        ...
        public static qb bQ(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof qb)) ? new C1065a(iBinder) : (qb) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 2:
                    ...
                    mo2090a(data.readInt(), data.readInt(), data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null);
    ...
    /* renamed from: a */
    void mo2090a(int i, int i2, Bundle bundle) throws RemoteException;
}
