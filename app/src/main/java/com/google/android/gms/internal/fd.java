...
@ey
public class fd extends gf implements C0447a {
    private final cy lA;
    ...
    class C04233 implements Runnable {
        ...
        L_0x002e:
            ...
            com.google.android.gms.internal.gr.m1340V(r0);	 Catch:{ all -> 0x005f }
            r0 = r7.tF;	 Catch:{ all -> 0x005f }
            r0 = r0.mo;	 Catch:{ all -> 0x005f }
            r1 = r7.tF;	 Catch:{ all -> 0x005f }
            r1 = r1.tn;	 Catch:{ all -> 0x005f }
        ...
        L_0x0062:
            ...
            r1 = r1.tn;	 Catch:{ all -> 0x005f }
            r1 = r1.sg;	 Catch:{ all -> 0x005f }
            r1 = com.google.android.gms.internal.gi.m1284L(r1);	 Catch:{ all -> 0x005f }
    ...
    private static final class C0425a extends Exception {
    ...
    public fd(Context context, C0432a c0432a, gu guVar, cy cyVar, C0420a c0420a) {
    ...
    /* renamed from: a */
    private void m3165a(fh fhVar, long j) throws C0425a {
        synchronized (this.tj) {
            this.tD = new cp(this.mContext, fhVar, this.lA, this.qi);
        }
        this.tE = this.tD.m1102a(j, 60000);
        switch (this.tE.qO) {
            case 0:
                return;
            case 1:
                throw new C0425a("No fill from any mediation ad networks.", 3);
            default:
                throw new C0425a("Unexpected mediation result: " + this.tE.qO, 0);
        }
    }

    /* renamed from: c */
    private boolean m3168c(long j) throws C0425a {
        ...
        try {
            ...
            throw new C0425a("Ad request cancelled.", -1);
        }
    }

    /* renamed from: f */
    private void m3170f(long j) throws C0425a {
        gq.wR.post(new C04233(this));
        m3171h(j);
    }

    /* renamed from: h */
    private void m3171h(long j) throws C0425a {
        while (m3168c(j)) {
            if (this.tC) {
                return;
            }
        }
        throw new C0425a("Timed out waiting for WebView to finish loading.", 2);
    }

    /* renamed from: a */
    public void mo1661a(gu guVar) {
        synchronized (this.mH) {
            gr.m1337S("WebView finished loading.");
            this.tC = true;
            this.mH.notify();
        }
    }
    ...
    public void cx() {
        synchronized (this.mH) {
            gr.m1337S("AdRendererBackgroundTask started.");
            fh fhVar = this.tB.vJ;
            int i = this.tB.errorCode;
            try {
                long elapsedRealtime = SystemClock.elapsedRealtime();
                if (this.tn.tW) {
                    m3165a(fhVar, elapsedRealtime);
                } else if (this.tn.uc) {
                    m3173g(elapsedRealtime);
                } else {
                    m3170f(elapsedRealtime);
                }
            } catch (C0425a e) {
                i = e.getErrorCode();
                if (i == 3 || i == -1) {
    ...
    /* renamed from: g */
    protected void m3173g(long j) throws C0425a {
        int i;
        int i2;
        ay ac = this.mo.ac();
        if (ac.oq) {
        ...
        gq.wR.post(new Runnable(this) {
            ...
            public void run() {
                synchronized (this.tF.mH) {
                    ...
                    this.tF.mo.dD().m1366a(this.tF);
                    fbVar.m1202b(this.tF.tn);
                }
            }
        });
        m3171h(j);
        if (fbVar.cH()) {
            gr.m1337S("Ad-Network indicated no fill with passback URL.");
            throw new C0425a("AdNetwork sent passback url", 3);
        } else if (!fbVar.cI()) {
            throw new C0425a("AdNetwork timed out", 2);
        }
    }
