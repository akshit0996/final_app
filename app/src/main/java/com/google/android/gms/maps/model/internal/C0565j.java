...
public interface C0565j extends IInterface {

    /* renamed from: com.google.android.gms.maps.model.internal.j$a */
    public static abstract class C1171a extends Binder implements C0565j {

        /* renamed from: com.google.android.gms.maps.model.internal.j$a$a */
        private static class C1170a implements C0565j {
            private IBinder le;
            ...
            /* renamed from: b */
            public boolean mo2399b(C0565j c0565j) throws RemoteException {
                boolean z = false;
        ...
        public static C0565j by(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0565j)) ? new C1170a(iBinder) : (C0565j) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 5:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IIndoorBuildingDelegate");
                    isUnderground = mo2399b(C1171a.by(data.readStrongBinder()));
                    reply.writeNoException();
                    if (isUnderground) {
                        i = 1;
                    }
    ...
    /* renamed from: b */
    boolean mo2399b(C0565j c0565j) throws RemoteException;
