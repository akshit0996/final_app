...
public interface C0569n extends IInterface {

    /* renamed from: com.google.android.gms.maps.model.internal.n$a */
    public static abstract class C1179a extends Binder implements C0569n {

        /* renamed from: com.google.android.gms.maps.model.internal.n$a$a */
        private static class C1178a implements C0569n {
            private IBinder le;
            ...
            /* renamed from: a */
            public boolean mo2457a(C0569n c0569n) throws RemoteException {
                boolean z = false;
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
                    obtain.writeStrongBinder(c0569n != null ? c0569n.asBinder() : null);
        ...
        public static C0569n bD(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0569n)) ? new C1178a(iBinder) : (C0569n) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 8:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
                    isVisible = mo2457a(C1179a.bD(data.readStrongBinder()));
                    reply.writeNoException();
                    if (isVisible) {
                        i = 1;
                    }
    ...
    /* renamed from: a */
    boolean mo2457a(C0569n c0569n) throws RemoteException;
