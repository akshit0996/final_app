...
public final class GameRequestCluster implements SafeParcelable, GameRequest {
    ...
    private void mp() {
        ...
        for (int i = 1; i < size; i++) {
            ...
            je.m1496a(gameRequest.getType() == gameRequest2.getType(), "All the requests must be of the same type");
            je.m1496a(gameRequest.getSender().equals(gameRequest2.getSender()), "All the requests must be from the same sender");
        }
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        GameRequestClusterCreator.m952a(this, dest, flags);
    }
}
