...
public abstract class WearableListenerService extends Service implements DataListener, MessageListener, NodeListener {
    ...
    private class C1477a extends C1265a {
        final /* synthetic */ WearableListenerService axq;

        private C1477a(WearableListenerService wearableListenerService) {
            this.axq = wearableListenerService;
        }

        /* renamed from: a */
        public void mo2610a(final ai aiVar) {
        ...
        /* renamed from: a */
        public void mo2611a(final al alVar) {
            if (Log.isLoggable("WearableLS", 3)) {
        ...
        /* renamed from: b */
        public void mo2613b(final al alVar) {
            if (Log.isLoggable("WearableLS", 3)) {
