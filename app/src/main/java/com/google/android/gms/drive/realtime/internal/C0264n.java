...
public interface C0264n extends IInterface {

    /* renamed from: com.google.android.gms.drive.realtime.internal.n$a */
    public static abstract class C0859a extends Binder implements C0264n {

        /* renamed from: com.google.android.gms.drive.realtime.internal.n$a$a */
        private static class C0858a implements C0264n {
            private IBinder le;
            ...
            /* renamed from: n */
            public void mo1128n(Status status) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.drive.realtime.internal.IStringCallback");
        ...
        public static C0264n am(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0264n)) ? new C0858a(iBinder) : (C0264n) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 2:
                    data.enforceInterface("com.google.android.gms.drive.realtime.internal.IStringCallback");
                    mo1128n(data.readInt() != 0 ? Status.CREATOR.createFromParcel(data) : null);
                    reply.writeNoException();
                    return true;
                case 1598968902:
    ...
    /* renamed from: n */
    void mo1128n(Status status) throws RemoteException;
}
