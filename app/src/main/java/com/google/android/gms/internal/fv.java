...
public final class fv {
    ...
    public fv(Context context) {
        ...
        this.vh = m1260a(packageManager, "geo:0,0?q=donuts") != null;
        this.vi = m1260a(packageManager, "http://www.google.com") != null;
        ...
        this.vp = m1261a(packageManager);
        this.vq = audioManager.getStreamVolume(3);
        this.vr = m1259a(context, connectivityManager, packageManager);
    ...
    /* renamed from: a */
    private static int m1259a(Context context, ConnectivityManager connectivityManager, PackageManager packageManager) {
        if (!gi.m1301a(packageManager, context.getPackageName(), "android.permission.ACCESS_NETWORK_STATE")) {
            return -2;
        }
    ...
    /* renamed from: a */
    private static ResolveInfo m1260a(PackageManager packageManager, String str) {
        return packageManager.resolveActivity(new Intent("android.intent.action.VIEW", Uri.parse(str)), 65536);
    }

    /* renamed from: a */
    private static String m1261a(PackageManager packageManager) {
        String str = null;
        ResolveInfo a = m1260a(packageManager, "market://details?id=com.google.android.gms.ads");
        if (a != null) {
