...
public class hp implements SafeParcelable {
    ...
    public static final class C0457a {
        ...
        /* renamed from: G */
        public C0457a m1404G(boolean z) {
            this.Dp = z;
            return this;
        }

        /* renamed from: H */
        public C0457a m1405H(boolean z) {
            this.Dr = z;
            return this;
        }

        /* renamed from: Q */
        public C0457a m1406Q(int i) {
            if (this.Du == null) {
                this.Du = new BitSet();
            }
            this.Du.set(i);
        ...
        public C0457a at(String str) {
            this.Do = str;
            return this;
        }

        public C0457a au(String str) {
            this.Dv = str;
            return this;
        }
