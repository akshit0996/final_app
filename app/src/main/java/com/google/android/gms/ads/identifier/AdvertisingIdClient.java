...
import com.google.android.gms.internal.C0502s;
import com.google.android.gms.internal.C0502s.C1078a;
...
public class AdvertisingIdClient {
    ...
    static class C0105a extends Thread {
        private WeakReference<AdvertisingIdClient> lt;
        private long lu;
        CountDownLatch lv = new CountDownLatch(1);
        boolean lw = false;

        public C0105a(AdvertisingIdClient advertisingIdClient, long j) {
    ...
    private void m14Z() {
        synchronized (this.lq) {
            ...
            if (this.ls > 0) {
                this.lr = new C0105a(this, this.ls);
            }
        }
    }

    /* renamed from: a */
    static C0502s m15a(Context context, C0151a c0151a) throws IOException {
        try {
            return C1078a.m3548b(c0151a.gs());
        } catch (InterruptedException e) {
    ...
    public static Info getAdvertisingIdInfo(Context context) throws IOException, IllegalStateException, GooglePlayServicesNotAvailableException, GooglePlayServicesRepairableException {
        ...
        try {
            advertisingIdClient.m17b(false);
    ...
    /* renamed from: h */
    static C0151a m16h(Context context) throws IOException, GooglePlayServicesNotAvailableException, GooglePlayServicesRepairableException {
        try {
            context.getPackageManager().getPackageInfo(GooglePlayServicesUtil.GOOGLE_PLAY_STORE_PACKAGE, 0);
            try {
                GooglePlayServicesUtil.m124C(context);
                Object c0151a = new C0151a();
                Intent intent = new Intent("com.google.android.gms.ads.identifier.service.START");
                intent.setPackage(GooglePlayServicesUtil.GOOGLE_PLAY_SERVICES_PACKAGE);
                if (context.bindService(intent, c0151a, 1)) {
                    return c0151a;
                }
    ...
    /* renamed from: b */
    protected void m17b(boolean z) throws IOException, IllegalStateException, GooglePlayServicesNotAvailableException, GooglePlayServicesRepairableException {
        jx.aV("Calling this from your main thread can lead to deadlock");
        synchronized (this) {
            if (this.lp) {
                finish();
            }
            this.ln = m16h(this.mContext);
            this.lo = m15a(this.mContext, this.ln);
            this.lp = true;
            if (z) {
                m14Z();
            }
    ...
    public Info getInfo() throws IOException {
        ...
        synchronized (this) {
            ...
            jx.m1582i(this.ln);
            jx.m1582i(this.lo);
            info = new Info(this.lo.getId(), this.lo.mo2120c(true));
        }
        m14Z();
        return info;
    }
