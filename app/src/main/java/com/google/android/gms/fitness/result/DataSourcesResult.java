...
public class DataSourcesResult implements Result, SafeParcelable {
    public static final Creator<DataSourcesResult> CREATOR = new C0342c();
    ...
    /* renamed from: D */
    public static DataSourcesResult m2718D(Status status) {
        return new DataSourcesResult(Collections.emptyList(), status);
    }

    /* renamed from: b */
    private boolean m2719b(DataSourcesResult dataSourcesResult) {
    ...
    public boolean equals(Object that) {
        return this == that || ((that instanceof DataSourcesResult) && m2719b((DataSourcesResult) that));
    }
    ...
    public String toString() {
        return jv.m1571h(this).m1570a("status", this.Eb).m1570a("dataSets", this.VH).toString();
    }

    public void writeToParcel(Parcel dest, int flags) {
        C0342c.m652a(this, dest, flags);
    }
}
