...
public class StreetViewPanoramaOrientation implements SafeParcelable {
    public static final C0582t CREATOR = new C0582t();
    ...
    public String toString() {
        return jv.m1571h(this).m1570a("tilt", Float.valueOf(this.tilt)).m1570a("bearing", Float.valueOf(this.bearing)).toString();
    }

    public void writeToParcel(Parcel out, int flags) {
        C0582t.m2019a(this, out, flags);
    }
}
