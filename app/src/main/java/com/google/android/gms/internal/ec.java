...
public class ec extends gf implements ServiceConnection {
    ...
    public ec(Context context, er erVar, ek ekVar) {
        ...
        this.sG = eh.m1161j(this.mContext);
        this.sH = this.sG.m1165d(10);
    }

    /* renamed from: a */
    private void m3126a(final ef efVar, String str, String str2) {
        ...
        gq.wR.post(new Runnable(this) {
            ...
            public void run() {
                try {
                    if (this.sL.sI.m1173a(efVar.sU, -1, intent)) {
                        this.sL.sE.mo1780a(new eg(this.sL.mContext, efVar.sV, true, -1, intent, efVar));
                    } else {
                        this.sL.sE.mo1780a(new eg(this.sL.mContext, efVar.sV, false, -1, intent, efVar));
                    }
                } catch (RemoteException e) {
                    gr.m1341W("Fail to verify and dispatch pending transaction");
                }
            }
        });
    }
    ...
    /* renamed from: b */
    private void m3128b(long j) {
        do {
            if (!m3130c(j)) {
                gr.m1341W("Timeout waiting for pending transaction to be processed.");
            }
        } while (!this.sD);
    }

    /* renamed from: c */
    private boolean m3130c(long j) {
        ...
        try {
            ...
            gr.m1341W("waitWithTimeout_lock interrupted");
        }
        return true;
    }
    ...
    private void cy() {
        if (!this.sH.isEmpty()) {
            ...
            String str = null;
            while (true) {
                Bundle d = this.sF.m1159d(this.mContext.getPackageName(), str);
                if (d == null || ei.m1168b(d) != 0) {
                    break;
                }
                ...
                for (int i = 0; i < stringArrayList.size(); i++) {
                    if (hashMap.containsKey(stringArrayList.get(i))) {
                        ...
                        if (efVar2.sU.equals(ei.m1166D(str2))) {
                            m3126a(efVar2, str2, str3);
                            hashMap.remove(str);
                        }
                    }
                }
            ...
            for (String str4 : hashMap.keySet()) {
                this.sG.m1163a((ef) hashMap.get(str4));
            }
        }
    }
    ...
    public void cx() {
        synchronized (this.mH) {
            ...
            m3128b(SystemClock.elapsedRealtime());
