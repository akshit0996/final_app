...
public final class TurnBasedMultiplayerImpl implements TurnBasedMultiplayer {
    ...
    class AnonymousClass11 extends InitiateMatchImpl {
        ...
        /* renamed from: a */
        protected void m5519a(GamesClientImpl gamesClientImpl) {
            gamesClientImpl.m4185c((C0155b) this, this.ZZ, this.abU);
        }
    }
    ...
    class AnonymousClass12 extends InitiateMatchImpl {
        ...
        /* renamed from: a */
        protected void m5521a(GamesClientImpl gamesClientImpl) {
            gamesClientImpl.m4197d((C0155b) this, this.ZZ, this.abU);
        }
    }
    ...
    class AnonymousClass13 extends LoadMatchesImpl {
        ...
        /* renamed from: a */
        protected void m5523a(GamesClientImpl gamesClientImpl) {
            gamesClientImpl.m4136a((C0155b) this, this.ZZ, this.abV, this.abW);
        }
    }

    public PendingResult<InitiateMatchResult> acceptInvitation(GoogleApiClient apiClient, final String invitationId) {
        return apiClient.mo928b(new InitiateMatchImpl(this, apiClient) {
            final /* synthetic */ TurnBasedMultiplayerImpl abT;

            /* renamed from: a */
            protected void m5529a(GamesClientImpl gamesClientImpl) {
                gamesClientImpl.m4194d((C0155b) this, invitationId);
            }
        });
    }

    public PendingResult<CancelMatchResult> cancelMatch(GoogleApiClient apiClient, final String matchId) {
        return apiClient.mo928b(new CancelMatchImpl(this, apiClient, matchId) {
            final /* synthetic */ TurnBasedMultiplayerImpl abT;

            /* renamed from: a */
            protected void m5539a(GamesClientImpl gamesClientImpl) {
                gamesClientImpl.m4207f((C0155b) this, matchId);
            }
        });
    }
    ...
    public PendingResult<InitiateMatchResult> createMatch(GoogleApiClient apiClient, final TurnBasedMatchConfig config) {
        return apiClient.mo928b(new InitiateMatchImpl(this, apiClient) {
            ...
            /* renamed from: a */
            protected void m5525a(GamesClientImpl gamesClientImpl) {
                gamesClientImpl.m4129a((C0155b) this, config);
            }
        });
    }

    public void declineInvitation(GoogleApiClient apiClient, String invitationId) {
        Games.m659d(apiClient).m4231q(invitationId, 1);
    }

    public void dismissInvitation(GoogleApiClient apiClient, String invitationId) {
        Games.m659d(apiClient).m4230p(invitationId, 1);
    }

    public void dismissMatch(GoogleApiClient apiClient, String matchId) {
        Games.m659d(apiClient).bA(matchId);
    }
    ...
    public PendingResult<UpdateMatchResult> finishMatch(GoogleApiClient apiClient, String matchId, byte[] matchData, ParticipantResult... results) {
        ...
        return apiClient.mo928b(new UpdateMatchImpl(this, apiClient) {
            final /* synthetic */ TurnBasedMultiplayerImpl abT;

            /* renamed from: a */
            protected void m5533a(GamesClientImpl gamesClientImpl) {
                gamesClientImpl.m4150a((C0155b) this, str, bArr, participantResultArr);
            }
        });
    }

    public Intent getInboxIntent(GoogleApiClient apiClient) {
        return Games.m659d(apiClient).ln();
    }

    public int getMaxMatchDataSize(GoogleApiClient apiClient) {
        return Games.m659d(apiClient).lx();
    }

    public Intent getSelectOpponentsIntent(GoogleApiClient apiClient, int minPlayers, int maxPlayers) {
        return Games.m659d(apiClient).m4117a(minPlayers, maxPlayers, true);
    }

    public Intent getSelectOpponentsIntent(GoogleApiClient apiClient, int minPlayers, int maxPlayers, boolean allowAutomatch) {
        return Games.m659d(apiClient).m4117a(minPlayers, maxPlayers, allowAutomatch);
    }

    public PendingResult<LeaveMatchResult> leaveMatch(GoogleApiClient apiClient, final String matchId) {
        return apiClient.mo928b(new LeaveMatchImpl(this, apiClient) {
            final /* synthetic */ TurnBasedMultiplayerImpl abT;

            /* renamed from: a */
            protected void m5535a(GamesClientImpl gamesClientImpl) {
                gamesClientImpl.m4201e((C0155b) this, matchId);
            }
        });
    }
    ...
    public PendingResult<LeaveMatchResult> leaveMatchDuringTurn(GoogleApiClient apiClient, final String matchId, final String pendingParticipantId) {
        return apiClient.mo928b(new LeaveMatchImpl(this, apiClient) {
            ...
            /* renamed from: a */
            protected void m5537a(GamesClientImpl gamesClientImpl) {
                gamesClientImpl.m4138a((C0155b) this, matchId, pendingParticipantId);
            }
        });
    }

    public PendingResult<LoadMatchResult> loadMatch(GoogleApiClient apiClient, final String matchId) {
        return apiClient.mo926a(new LoadMatchImpl(this, apiClient) {
            final /* synthetic */ TurnBasedMultiplayerImpl abT;

            /* renamed from: a */
            protected void m5517a(GamesClientImpl gamesClientImpl) {
                gamesClientImpl.m4212g((C0155b) this, matchId);
            }
        });
    }
    ...
    public PendingResult<LoadMatchesResult> loadMatchesByStatus(GoogleApiClient apiClient, final int invitationSortOrder, final int[] matchTurnStatuses) {
        return apiClient.mo926a(new LoadMatchesImpl(this, apiClient) {
            final /* synthetic */ TurnBasedMultiplayerImpl abT;

            /* renamed from: a */
            protected void m5541a(GamesClientImpl gamesClientImpl) {
                gamesClientImpl.m4127a((C0155b) this, invitationSortOrder, matchTurnStatuses);
            }
        });
    }
    ...
    public void registerMatchUpdateListener(GoogleApiClient apiClient, OnTurnBasedMatchUpdateReceivedListener listener) {
        Games.m659d(apiClient).m4178b(apiClient.mo933d(listener));
    }
    ...
    public PendingResult<InitiateMatchResult> rematch(GoogleApiClient apiClient, final String matchId) {
        return apiClient.mo928b(new InitiateMatchImpl(this, apiClient) {
            ...
            /* renamed from: a */
            protected void m5527a(GamesClientImpl gamesClientImpl) {
                gamesClientImpl.m4182c((C0155b) this, matchId);
            }
        });
    }
    ...
    public PendingResult<UpdateMatchResult> takeTurn(GoogleApiClient apiClient, String matchId, byte[] matchData, String pendingParticipantId, ParticipantResult... results) {
        ...
        return apiClient.mo928b(new UpdateMatchImpl(this, apiClient) {
            ...
            /* renamed from: a */
            protected void m5531a(GamesClientImpl gamesClientImpl) {
                gamesClientImpl.m4149a((C0155b) this, str, bArr, str2, participantResultArr);
            }
        });
    }

    public void unregisterMatchUpdateListener(GoogleApiClient apiClient) {
        Games.m659d(apiClient).lq();
    }
}
