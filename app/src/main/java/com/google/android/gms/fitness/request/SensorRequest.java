...
public class SensorRequest {
    ...
    public static class Builder {
        ...
        public Builder setFastestRate(int fastestInterval, TimeUnit unit) {
            jx.m1580b(fastestInterval >= 0, (Object) "Cannot use a negative interval");
            this.Wg = true;
        ...
        public Builder setMaxDeliveryLatency(int interval, TimeUnit unit) {
            jx.m1580b(interval >= 0, (Object) "Cannot use a negative delivery interval");
            this.VZ = unit.toMicros((long) interval);
            return this;
        }

        public Builder setSamplingRate(long interval, TimeUnit unit) {
            jx.m1580b(interval >= 0, (Object) "Cannot use a negative sampling interval");
        ...
        public Builder setTimeout(long timeout, TimeUnit timeUnit) {
            boolean z = true;
            jx.m1581b(timeout > 0, "Invalid time out value specified: %d", Long.valueOf(timeout));
            if (timeUnit == null) {
                z = false;
            }
            jx.m1580b(z, (Object) "Invalid time unit specified");
    ...
    /* renamed from: a */
    private static int m590a(LocationRequest locationRequest) {
    ...
    /* renamed from: a */
    private boolean m591a(SensorRequest sensorRequest) {
    ...
    public boolean equals(Object that) {
        return this == that || ((that instanceof SensorRequest) && m591a((SensorRequest) that));
    }
    ...
    public String toString() {
        return jv.m1571h(this).m1570a("dataSource", this.TN).m1570a("dataType", this.TM).m1570a("samplingRateMicros", Long.valueOf(this.UQ)).m1570a("deliveryLatencyMicros", Long.valueOf(this.VZ)).m1570a("timeOutMicros", Long.valueOf(this.Wf)).toString();
    }
}
