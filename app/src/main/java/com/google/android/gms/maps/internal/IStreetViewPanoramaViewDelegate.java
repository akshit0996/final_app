...
public interface IStreetViewPanoramaViewDelegate extends IInterface {
    ...
    public static abstract class C1112a extends Binder implements IStreetViewPanoramaViewDelegate {

        /* renamed from: com.google.android.gms.maps.internal.IStreetViewPanoramaViewDelegate$a$a */
        private static class C1111a implements IStreetViewPanoramaViewDelegate {
            private IBinder le;
            ...
            public IStreetViewPanoramaDelegate getStreetViewPanorama() throws RemoteException {
                ...
                try {
                    ...
                    IStreetViewPanoramaDelegate br = C1108a.br(obtain2.readStrongBinder());
                    return br;
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void getStreetViewPanoramaAsync(C0545u callback) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaViewDelegate");
        ...
        public static IStreetViewPanoramaViewDelegate bt(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IStreetViewPanoramaViewDelegate)) ? new C1111a(iBinder) : (IStreetViewPanoramaViewDelegate) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 9:
                    data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaViewDelegate");
                    getStreetViewPanoramaAsync(C1154a.bo(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 1598968902:
    ...
    void getStreetViewPanoramaAsync(C0545u c0545u) throws RemoteException;
