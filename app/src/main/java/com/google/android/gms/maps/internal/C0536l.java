...
public interface C0536l extends IInterface {

    /* renamed from: com.google.android.gms.maps.internal.l$a */
    public static abstract class C1136a extends Binder implements C0536l {

        /* renamed from: com.google.android.gms.maps.internal.l$a$a */
        private static class C1135a implements C0536l {
            private IBinder le;
        ...
        public static C0536l bf(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.IOnMapLongClickListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0536l)) ? new C1135a(iBinder) : (C0536l) queryLocalInterface;
        }
