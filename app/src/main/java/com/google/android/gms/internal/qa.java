...
public interface qa extends IInterface {
    ...
    public static abstract class C1064a extends Binder implements qa {

        /* renamed from: com.google.android.gms.internal.qa$a$a */
        private static class C1063a implements qa {
            private IBinder le;
            ...
            /* renamed from: a */
            public void mo2076a(C0272d c0272d, WalletFragmentOptions walletFragmentOptions, Bundle bundle) throws RemoteException {
        ...
        public static qa bP(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof qa)) ? new C1063a(iBinder) : (qa) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    mo2076a(C0871a.ap(data.readStrongBinder()), data.readInt() != 0 ? (WalletFragmentOptions) WalletFragmentOptions.CREATOR.createFromParcel(data) : null, data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null);
    ...
    /* renamed from: a */
    void mo2076a(C0272d c0272d, WalletFragmentOptions walletFragmentOptions, Bundle bundle) throws RemoteException;
