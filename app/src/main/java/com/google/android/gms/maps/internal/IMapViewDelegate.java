...
public interface IMapViewDelegate extends IInterface {
    ...
    public static abstract class C1104a extends Binder implements IMapViewDelegate {

        /* renamed from: com.google.android.gms.maps.internal.IMapViewDelegate$a$a */
        private static class C1103a implements IMapViewDelegate {
            private IBinder le;
        ...
        public static IMapViewDelegate aY(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IMapViewDelegate)) ? new C1103a(iBinder) : (IMapViewDelegate) queryLocalInterface;
        }
