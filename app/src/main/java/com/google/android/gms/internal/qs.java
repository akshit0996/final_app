...
class qs {
    ...
    /* renamed from: a */
    private boolean m1896a(int[] iArr, int[] iArr2, int i) {
    ...
    /* renamed from: a */
    private boolean m1897a(qt[] qtVarArr, qt[] qtVarArr2, int i) {
        for (int i2 = 0; i2 < i; i2++) {
    ...
    /* renamed from: a */
    public void m1898a(int i, qt qtVar) {
        int hj = hj(i);
        if (hj >= 0) {
            this.azc[hj] = qtVar;
            return;
    ...
    public boolean equals(Object o) {
        ...
        return m1896a(this.azb, qsVar.azb, this.mSize) && m1897a(this.azc, qsVar.azc, this.mSize);
    }
