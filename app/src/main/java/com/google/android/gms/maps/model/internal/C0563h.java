...
public interface C0563h extends IInterface {

    /* renamed from: com.google.android.gms.maps.model.internal.h$a */
    public static abstract class C1167a extends Binder implements C0563h {

        /* renamed from: com.google.android.gms.maps.model.internal.h$a$a */
        private static class C1166a implements C0563h {
            private IBinder le;
            ...
            /* renamed from: a */
            public boolean mo2359a(C0563h c0563h) throws RemoteException {
                boolean z = false;
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.ICircleDelegate");
                    obtain.writeStrongBinder(c0563h != null ? c0563h.asBinder() : null);
        ...
        public static C0563h bw(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.model.internal.ICircleDelegate");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0563h)) ? new C1166a(iBinder) : (C0563h) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 17:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.ICircleDelegate");
                    isVisible = mo2359a(C1167a.bw(data.readStrongBinder()));
                    reply.writeNoException();
                    if (isVisible) {
                        i = 1;
                    }
    ...
    /* renamed from: a */
    boolean mo2359a(C0563h c0563h) throws RemoteException;
