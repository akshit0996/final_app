...
public interface IGamesSignInCallbacks extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IGamesSignInCallbacks {
        ...
        private static class Proxy implements IGamesSignInCallbacks {
            ...
            /* renamed from: U */
            public void mo1439U(DataHolder dataHolder) throws RemoteException {
            ...
            /* renamed from: V */
            public void mo1440V(DataHolder dataHolder) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.games.internal.IGamesSignInCallbacks");
            ...
            /* renamed from: b */
            public void mo1441b(int i, Intent intent) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.games.internal.IGamesSignInCallbacks");
            ...
            /* renamed from: g */
            public void mo1445g(DataHolder dataHolder) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.games.internal.IGamesSignInCallbacks");
    ...
    /* renamed from: U */
    void mo1439U(DataHolder dataHolder) throws RemoteException;

    /* renamed from: V */
    void mo1440V(DataHolder dataHolder) throws RemoteException;

    /* renamed from: b */
    void mo1441b(int i, Intent intent) throws RemoteException;
    ...
    /* renamed from: g */
    void mo1445g(DataHolder dataHolder) throws RemoteException;
}
