...
public final class WalletFragmentInitParams implements SafeParcelable {
    public static final Creator<WalletFragmentInitParams> CREATOR = new C0668a();
    final int CK;
    private String DZ;
    ...
    public final class Builder {
        ...
        public WalletFragmentInitParams build() {
            ...
            jx.m1576a(z2, "Exactly one of MaskedWallet or MaskedWalletRequest is required");
            if (this.awv.awu < 0) {
                z = false;
            }
            jx.m1576a(z, "masked wallet request code is required and must be non-negative");
            return this.awv;
        }
