...
public class an {
    ...
    /* renamed from: E */
    static String m52E(boolean z) {
        return z ? "1" : "0";
    }

    /* renamed from: a */
    public static double m53a(String str, double d) {
        if (str != null) {
            try {
    ...
    /* renamed from: a */
    public static String m54a(Locale locale) {
    ...
    /* renamed from: a */
    public static void m55a(Map<String, String> map, String str, C0125q c0125q) {
        if (!map.containsKey(str)) {
            map.put(str, c0125q.getValue(str));
        }
    }

    /* renamed from: a */
    public static void m56a(Map<String, String> map, String str, String str2) {
        if (!map.containsKey(str)) {
            map.put(str, str2);
        }
    }
    ...
    /* renamed from: f */
    public static boolean m57f(String str, boolean z) {
