...
public class GeofencingRequest implements SafeParcelable {
    public static final Creator<GeofencingRequest> CREATOR = new C0516a();
    ...
    public static final class Builder {
        ...
        public Builder addGeofence(Geofence geofence) {
            jx.m1578b((Object) geofence, (Object) "geofence can't be null.");
            jx.m1580b(geofence instanceof nn, (Object) "Geofence must be created using Geofence.Builder.");
        ...
        public GeofencingRequest build() {
            jx.m1580b(!this.ago.isEmpty(), (Object) "No geofence has been added to this request.");
