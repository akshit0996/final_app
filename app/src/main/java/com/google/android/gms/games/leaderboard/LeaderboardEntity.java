...
public final class LeaderboardEntity implements Leaderboard {
    ...
    /* renamed from: a */
    static int m4237a(Leaderboard leaderboard) {
    ...
    /* renamed from: a */
    static boolean m4238a(Leaderboard leaderboard, Object obj) {
    ...
    /* renamed from: b */
    static String m4239b(Leaderboard leaderboard) {
        return jv.m1571h(leaderboard).m1570a("LeaderboardId", leaderboard.getLeaderboardId()).m1570a("DisplayName", leaderboard.getDisplayName()).m1570a("IconImageUri", leaderboard.getIconImageUri()).m1570a("IconImageUrl", leaderboard.getIconImageUrl()).m1570a("ScoreOrder", Integer.valueOf(leaderboard.getScoreOrder())).m1570a("Variants", leaderboard.getVariants()).toString();
    }

    public boolean equals(Object obj) {
        return m4238a(this, obj);
    }
