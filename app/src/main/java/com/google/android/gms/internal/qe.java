...
public interface qe extends IInterface {
    ...
    public static abstract class C1072a extends Binder implements qe {

        /* renamed from: com.google.android.gms.internal.qe$a$a */
        private static class C1071a implements qe {
            private IBinder le;
            ...
            /* renamed from: b */
            public void mo2102b(int i, int i2, Bundle bundle) throws RemoteException {
        ...
        public static qe bT(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof qe)) ? new C1071a(iBinder) : (qe) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    mo2102b(data.readInt(), data.readInt(), data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null);
    ...
    /* renamed from: b */
    void mo2102b(int i, int i2, Bundle bundle) throws RemoteException;
}
