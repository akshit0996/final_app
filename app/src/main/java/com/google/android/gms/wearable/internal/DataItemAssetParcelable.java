...
public class DataItemAssetParcelable implements SafeParcelable, DataItemAsset {
    public static final Creator<DataItemAssetParcelable> CREATOR = new C0704j();
    ...
    public DataItemAssetParcelable(DataItemAsset value) {
        this.CK = 1;
        this.CE = (String) jx.m1582i(value.getId());
        this.KP = (String) jx.m1582i(value.getDataItemKey());
    }
