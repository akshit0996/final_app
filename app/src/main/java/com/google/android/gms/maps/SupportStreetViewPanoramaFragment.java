...
public class SupportStreetViewPanoramaFragment extends Fragment {
    ...
    static class C1094b extends C0270a<C1465a> {
        ...
        /* renamed from: a */
        protected void mo2135a(C0273f<C1465a> c0273f) {
            this.akW = c0273f;
            nO();
        }
        ...
        public void getStreetViewPanoramaAsync(OnStreetViewPanoramaReadyCallback callback) {
            if (je() != null) {
                ((C1465a) je()).getStreetViewPanoramaAsync(callback);
            } else {
        ...
        public void nO() {
            if (this.nB != null && this.akW != null && je() == null) {
                try {
                    ...
                    this.akW.mo1131a(new C1465a(this.Mx, C0548x.m1974S(this.nB).mo2306k(C1332e.m4013k(this.nB))));
                    for (OnStreetViewPanoramaReadyCallback streetViewPanoramaAsync : this.alq) {
                        ((C1465a) je()).getStreetViewPanoramaAsync(streetViewPanoramaAsync);
                    }
                    this.alq.clear();
    ...
    static class C1465a implements StreetViewLifecycleDelegate {
        private final Fragment Mx;
        private final IStreetViewPanoramaFragmentDelegate aln;

        public C1465a(Fragment fragment, IStreetViewPanoramaFragmentDelegate iStreetViewPanoramaFragmentDelegate) {
    ...
    protected IStreetViewPanoramaFragmentDelegate nR() {
        this.alF.nO();
        return this.alF.je() == null ? null : ((C1465a) this.alF.je()).nR();
    }
