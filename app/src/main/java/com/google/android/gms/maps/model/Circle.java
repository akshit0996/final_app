...
import com.google.android.gms.maps.model.internal.C0563h;

public final class Circle {
    private final C0563h alR;

    public Circle(C0563h delegate) {
        this.alR = (C0563h) jx.m1582i(delegate);
    }
    ...
    public boolean equals(Object other) {
        ...
        try {
            return this.alR.mo2359a(((Circle) other).alR);
