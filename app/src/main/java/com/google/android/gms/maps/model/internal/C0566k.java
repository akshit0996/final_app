...
public interface C0566k extends IInterface {

    /* renamed from: com.google.android.gms.maps.model.internal.k$a */
    public static abstract class C1173a extends Binder implements C0566k {

        /* renamed from: com.google.android.gms.maps.model.internal.k$a$a */
        private static class C1172a implements C0566k {
            private IBinder le;
            ...
            /* renamed from: a */
            public boolean mo2405a(C0566k c0566k) throws RemoteException {
                boolean z = false;
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IIndoorLevelDelegate");
                    obtain.writeStrongBinder(c0566k != null ? c0566k.asBinder() : null);
        ...
        public static C0566k bz(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.model.internal.IIndoorLevelDelegate");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0566k)) ? new C1172a(iBinder) : (C0566k) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 4:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IIndoorLevelDelegate");
                    boolean a = mo2405a(C1173a.bz(data.readStrongBinder()));
                    reply.writeNoException();
    ...
    /* renamed from: a */
    boolean mo2405a(C0566k c0566k) throws RemoteException;
