...
public class gu extends WebView implements DownloadListener {
    ...
    protected static class C0445a extends MutableContextWrapper {
        private Context mO;
        private Activity xd;
    ...
    protected gu(C0445a c0445a, ay ayVar, boolean z, boolean z2, C0484k c0484k, gs gsVar) {
        super(c0445a);
        this.wX = c0445a;
        this.qI = ayVar;
        this.wZ = z;
        ...
        gi.m1292a((Context) c0445a, gsVar.wS, settings);
        if (VERSION.SDK_INT >= 17) {
            go.m1329a(getContext(), settings);
        } else if (VERSION.SDK_INT >= 11) {
            gm.m1321a(getContext(), settings);
        }
    ...
    /* renamed from: a */
    public static gu m1350a(Context context, ay ayVar, boolean z, boolean z2, C0484k c0484k, gs gsVar) {
        return new gu(new C0445a(context), ayVar, z, z2, c0484k, gsVar);
    }
    ...
    private void dJ() {
        synchronized (this.mH) {
            if (this.wZ || this.qI.oq) {
                if (VERSION.SDK_INT < 14) {
                    gr.m1337S("Disabling hardware acceleration on an overlay.");
                    dK();
                } else {
                    gr.m1337S("Enabling hardware acceleration on an overlay.");
                    dL();
                }
            } else if (VERSION.SDK_INT < 18) {
                gr.m1337S("Disabling hardware acceleration on an AdView.");
                dK();
            } else {
                gr.m1337S("Enabling hardware acceleration on an AdView.");
                dL();
            }
        }
    }
    ...
    /* renamed from: X */
    protected void m1351X(String str) {
        synchronized (this.mH) {
            if (isDestroyed()) {
                gr.m1341W("The webview is destroyed. Ignoring action.");
            } else {
                loadUrl(str);
            }
        }
    ...
    /* renamed from: a */
    public void m1352a(Context context, ay ayVar) {
        synchronized (this.mH) {
    ...
    /* renamed from: a */
    public void m1355a(String str, Map<String, ?> map) {
        try {
            m1357b(str, gi.m1312t((Map) map));
        } catch (JSONException e) {
            gr.m1341W("Could not convert parameters to JSON.");
        }
    }

    /* renamed from: a */
    public void m1356a(String str, JSONObject jSONObject) {
        if (jSONObject == null) {
    ...
    /* renamed from: b */
    public void m1357b(String str, JSONObject jSONObject) {
        if (jSONObject == null) {
            jSONObject = new JSONObject();
        }
        String jSONObject2 = jSONObject.toString();
        ...
        stringBuilder.append(jSONObject2);
        stringBuilder.append(");");
        gr.m1340V("Dispatching AFMA event: " + stringBuilder);
        m1351X(stringBuilder.toString());
    }
    ...
    public void cb() {
        if (dD().dN()) {
            ...
            int s = gi.m1311s(getContext());
            float f = 160.0f / ((float) displayMetrics.densityDpi);
            int round = Math.round(((float) displayMetrics.widthPixels) * f);
            try {
                m1357b("onScreenInfoChanged", new JSONObject().put("width", round).put("height", Math.round(((float) (displayMetrics.heightPixels - s)) * f)).put("density", (double) displayMetrics.density).put("rotation", defaultDisplay.getRotation()));
            } catch (Throwable e) {
    ...
    public void ci() {
        ...
        m1355a("onshow", hashMap);
    }

    public void cj() {
        Map hashMap = new HashMap(1);
        hashMap.put("version", this.qJ.wS);
        m1355a("onhide", hashMap);
    }
    ...
    L_0x0009:
        ...
        com.google.android.gms.internal.gr.m1341W(r0);	 Catch:{ all -> 0x001b }
    ...
    public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimeType, long size) {
        try {
            ...
            gr.m1337S("Couldn't find an Activity to view url/mimetype: " + url + " / " + mimeType);
        }
    }
    ...
    L_0x0041:
        ...
        com.google.android.gms.internal.gr.m1341W(r0);	 Catch:{ all -> 0x00ae }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (this.tl != null) {
            this.tl.m1593a(event);
        }
        return super.onTouchEvent(event);
    }

    /* renamed from: q */
    public void m1358q(boolean z) {
        synchronized (this.mH) {
            if (this.wY != null) {
                this.wY.m4364q(z);
            } else {
