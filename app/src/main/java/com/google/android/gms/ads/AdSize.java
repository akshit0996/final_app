...
public final class AdSize {
    ...
    public int getHeightInPixels(Context context) {
        return this.lj == -2 ? ay.m3051b(context.getResources().getDisplayMetrics()) : gq.m1331a(context, this.lj);
    }
    ...
    public int getWidthInPixels(Context context) {
        return this.li == -1 ? ay.m3050a(context.getResources().getDisplayMetrics()) : gq.m1331a(context, this.li);
    }
