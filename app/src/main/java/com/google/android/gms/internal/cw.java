...
public final class cw {
    /* renamed from: a */
    public static List<String> m1105a(JSONObject jSONObject, String str) throws JSONException {
    ...
    /* renamed from: a */
    public static void m1106a(Context context, String str, fy fyVar, String str2, boolean z, List<String> list) {
        String str3 = z ? "1" : "0";
