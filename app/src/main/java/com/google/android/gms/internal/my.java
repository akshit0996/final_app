...
public interface my extends IInterface {
    ...
    public static abstract class C1043a extends Binder implements my {

        /* renamed from: com.google.android.gms.internal.my$a$a */
        private static class C1042a implements my {
            private IBinder le;
            ...
            /* renamed from: a */
            public void mo1983a(mx mxVar, UserAddressRequest userAddressRequest, Bundle bundle) throws RemoteException {
        ...
        public static my aK(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof my)) ? new C1042a(iBinder) : (my) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 2:
                    ...
                    mo1983a(C1041a.aJ(data.readStrongBinder()), data.readInt() != 0 ? (UserAddressRequest) UserAddressRequest.CREATOR.createFromParcel(data) : null, data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null);
    ...
    /* renamed from: a */
    void mo1983a(mx mxVar, UserAddressRequest userAddressRequest, Bundle bundle) throws RemoteException;
}
