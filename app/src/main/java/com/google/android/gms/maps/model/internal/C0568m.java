...
public interface C0568m extends IInterface {

    /* renamed from: com.google.android.gms.maps.model.internal.m$a */
    public static abstract class C1177a extends Binder implements C0568m {

        /* renamed from: com.google.android.gms.maps.model.internal.m$a$a */
        private static class C1176a implements C0568m {
            private IBinder le;
            ...
            /* renamed from: a */
            public boolean mo2437a(C0568m c0568m) throws RemoteException {
                boolean z = false;
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IPolygonDelegate");
                    obtain.writeStrongBinder(c0568m != null ? c0568m.asBinder() : null);
        ...
        public static C0568m bB(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.model.internal.IPolygonDelegate");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0568m)) ? new C1176a(iBinder) : (C0568m) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case TimeUtils.HUNDRED_DAY_FIELD_LEN /*19*/:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IPolygonDelegate");
                    isVisible = mo2437a(C1177a.bB(data.readStrongBinder()));
                    reply.writeNoException();
                    if (isVisible) {
                        i = 1;
                    }
    ...
    /* renamed from: a */
    boolean mo2437a(C0568m c0568m) throws RemoteException;
