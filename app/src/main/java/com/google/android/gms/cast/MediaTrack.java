...
public final class MediaTrack {
    ...
    public static class Builder {
        ...
        public Builder setLanguage(Locale locale) {
            this.Gv.setLanguage(in.m1449b(locale));
            return this;
        }
    ...
    /* renamed from: c */
    private void m111c(JSONObject jSONObject) throws JSONException {
        clear();
    ...
    public boolean equals(Object other) {
        ...
        if (this.Ga != null && mediaTrack.Ga != null && !li.m1644d(this.Ga, mediaTrack.Ga)) {
            return false;
        }
        if (!(this.Eg == mediaTrack.Eg && this.Gt == mediaTrack.Gt && in.m1447a(this.FT, mediaTrack.FT) && in.m1447a(this.FV, mediaTrack.FV) && in.m1447a(this.mName, mediaTrack.mName) && in.m1447a(this.FR, mediaTrack.FR) && this.Gu == mediaTrack.Gu)) {
            z = false;
        }
        return z;
    }
