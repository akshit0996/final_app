...
public final class GroundOverlay {
    private final C0564i alZ;

    public GroundOverlay(C0564i delegate) {
        this.alZ = (C0564i) jx.m1582i(delegate);
    }
    ...
    public boolean equals(Object other) {
        ...
        try {
            return this.alZ.mo2379a(((GroundOverlay) other).alZ);
