...
public interface eo extends IInterface {
    ...
    public static abstract class C0946a extends Binder implements eo {

        /* renamed from: com.google.android.gms.internal.eo$a$a */
        private static class C0945a implements eo {
            private IBinder le;
        ...
        /* renamed from: w */
        public static eo m3134w(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof eo)) ? new C0945a(iBinder) : (eo) queryLocalInterface;
        }
