...
public interface ae extends IInterface {
    ...
    public static abstract class C1265a extends Binder implements ae {

        /* renamed from: com.google.android.gms.wearable.internal.ae$a$a */
        private static class C1264a implements ae {
            private IBinder le;

            C1264a(IBinder iBinder) {
                this.le = iBinder;
            }

            /* renamed from: a */
            public void mo2610a(ai aiVar) throws RemoteException {
            ...
            /* renamed from: a */
            public void mo2611a(al alVar) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.wearable.internal.IWearableListener");
                    if (alVar != null) {
            ...
            /* renamed from: b */
            public void mo2613b(al alVar) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.wearable.internal.IWearableListener");
                    if (alVar != null) {
        ...
        public static ae bY(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ae)) ? new C1264a(iBinder) : (ae) queryLocalInterface;
        }
    ...
    /* renamed from: a */
    void mo2610a(ai aiVar) throws RemoteException;

    /* renamed from: a */
    void mo2611a(al alVar) throws RemoteException;

    void aa(DataHolder dataHolder) throws RemoteException;

    /* renamed from: b */
    void mo2613b(al alVar) throws RemoteException;
}
