...
public final class LeaderboardScoreRef extends C0174d implements LeaderboardScore {
    ...
    public boolean equals(Object obj) {
        return LeaderboardScoreEntity.m4241a(this, obj);
    }
    ...
    public void getScoreHolderDisplayName(CharArrayBuffer dataOut) {
        if (aS("external_player_id")) {
            m172a("default_display_name", dataOut);
        } else {
    ...
    public int hashCode() {
        return LeaderboardScoreEntity.m4240a(this);
    }
    ...
    public String toString() {
        return LeaderboardScoreEntity.m4242b(this);
    }
}
