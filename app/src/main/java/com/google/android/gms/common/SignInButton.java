...
public final class SignInButton extends FrameLayout implements OnClickListener {
    ...
    /* renamed from: G */
    private void m143G(Context context) {
        if (this.Jk != null) {
            removeView(this.Jk);
        }
        try {
            this.Jk = jy.m3363b(context, this.mSize, this.mColor);
        } catch (C0274a e) {
            Log.w("SignInButton", "Sign in button not found, using placeholder instead");
            this.Jk = m144a(context, this.mSize, this.mColor);
        }
        addView(this.Jk);
    ...
    /* renamed from: a */
    private static Button m144a(Context context, int i, int i2) {
        Button jzVar = new jz(context);
        jzVar.m1587a(context.getResources(), i, i2);
        return jzVar;
    }
    ...
    public void setStyle(int buttonSize, int colorScheme) {
        ...
        jx.m1577a(z, "Unknown button size %d", Integer.valueOf(buttonSize));
        z = colorScheme >= 0 && colorScheme < 2;
        jx.m1577a(z, "Unknown color scheme %s", Integer.valueOf(colorScheme));
