...
public interface jr extends IInterface {
    ...
    public static abstract class C1004a extends Binder implements jr {

        /* renamed from: com.google.android.gms.internal.jr$a$a */
        private static class C1003a implements jr {
            private IBinder le;
        ...
        /* renamed from: O */
        public static jr m3314O(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.common.internal.ICancelToken");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof jr)) ? new C1003a(iBinder) : (jr) queryLocalInterface;
        }
