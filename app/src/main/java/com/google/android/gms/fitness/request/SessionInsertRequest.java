...
public class SessionInsertRequest implements SafeParcelable {
    public static final Creator<SessionInsertRequest> CREATOR = new C0331s();
    ...
    public static class Builder {
        ...
        /* renamed from: d */
        private void m595d(DataPoint dataPoint) {
            m597f(dataPoint);
            m596e(dataPoint);
        }

        /* renamed from: e */
        private void m596e(DataPoint dataPoint) {
            ...
            if (startTime2 != 0 && endTime2 != 0) {
                ...
                if (endTime2 > endTime) {
                    endTime2 = lt.m1649a(endTime2, TimeUnit.NANOSECONDS, timeUnit);
                }
                boolean z = startTime2 >= startTime && endTime2 <= endTime;
                jx.m1577a(z, "Data point %s has start and end times outside session interval [%d, %d]", dataPoint, Long.valueOf(startTime), Long.valueOf(endTime));
        ...
        /* renamed from: f */
        private void m597f(DataPoint dataPoint) {
            long startTime = this.TQ.getStartTime(TimeUnit.NANOSECONDS);
            long endTime = this.TQ.getEndTime(TimeUnit.NANOSECONDS);
            ...
            if (timestamp != 0) {
                ...
                if (timestamp < startTime || timestamp > endTime) {
                    timestamp = lt.m1649a(timestamp, TimeUnit.NANOSECONDS, timeUnit);
                }
                boolean z = timestamp >= startTime && timestamp <= endTime;
                jx.m1577a(z, "Data point %s has time stamp outside session interval [%d, %d]", dataPoint, Long.valueOf(startTime), Long.valueOf(endTime));
        ...
        public Builder addAggregateDataPoint(DataPoint aggregateDataPoint) {
            jx.m1580b(aggregateDataPoint != null, (Object) "Must specify a valid aggregate data point.");
            ...
            jx.m1581b(z, "Aggregate data point should have valid start and end times: %s", aggregateDataPoint);
            DataSource dataSource = aggregateDataPoint.getDataSource();
            jx.m1577a(!this.Wi.contains(dataSource), "Data set/Aggregate data point for this data source %s is already added.", dataSource);
        ...
        public Builder addDataSet(DataSet dataSet) {
            boolean z = true;
            jx.m1580b(dataSet != null, (Object) "Must specify a valid data set.");
            DataSource dataSource = dataSet.getDataSource();
            jx.m1577a(!this.Wi.contains(dataSource), "Data set for this data source %s is already added.", dataSource);
            if (dataSet.getDataPoints().isEmpty()) {
                z = false;
            }
            jx.m1580b(z, (Object) "No data points specified in the input data set.");
            this.Wi.add(dataSource);
            this.Ua.add(dataSet);
            return this;
        }
        ...
        public SessionInsertRequest build() {
            boolean z = true;
            jx.m1576a(this.TQ != null, "Must specify a valid session.");
            if (this.TQ.getEndTime(TimeUnit.MILLISECONDS) == 0) {
                z = false;
            }
            jx.m1576a(z, "Must specify a valid end time, cannot insert a continuing session.");
            ki();
    ...
    /* renamed from: a */
    private boolean m2701a(SessionInsertRequest sessionInsertRequest) {
    ...
    public boolean equals(Object o) {
        return o == this || ((o instanceof SessionInsertRequest) && m2701a((SessionInsertRequest) o));
    }
    ...
    public String toString() {
        return jv.m1571h(this).m1570a("session", this.TQ).m1570a("dataSets", this.Ua).m1570a("aggregateDataPoints", this.Wh).toString();
    }

    public void writeToParcel(Parcel dest, int flags) {
        C0331s.m640a(this, dest, flags);
    }
}
