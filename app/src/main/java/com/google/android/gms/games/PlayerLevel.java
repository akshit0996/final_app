...
public final class PlayerLevel implements SafeParcelable {
    ...
    PlayerLevel(int versionCode, int levelNumber, long minXp, long maxXp) {
        boolean z = true;
        jx.m1576a(minXp >= 0, "Min XP must be positive!");
        if (maxXp <= minXp) {
            z = false;
        }
        jx.m1576a(z, "Max XP must be more than min XP!");
        this.CK = versionCode;
        this.Xo = levelNumber;
        this.Xp = minXp;
        this.Xq = maxXp;
    ...
    public String toString() {
        return jv.m1571h(this).m1570a("LevelNumber", Integer.valueOf(getLevelNumber())).m1570a("MinXp", Long.valueOf(getMinXp())).m1570a("MaxXp", Long.valueOf(getMaxXp())).toString();
    }

    public void writeToParcel(Parcel out, int flags) {
        PlayerLevelCreator.m663a(this, out, flags);
    }
}
