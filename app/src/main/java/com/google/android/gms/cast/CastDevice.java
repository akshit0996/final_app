...
public class CastDevice implements SafeParcelable {
    public static final Creator<CastDevice> CREATOR = new C0148b();
    ...
    public boolean equals(Object obj) {
        ...
        return getDeviceId() == null ? castDevice.getDeviceId() == null : in.m1447a(this.FG, castDevice.FG) && in.m1447a(this.FI, castDevice.FI) && in.m1447a(this.FK, castDevice.FK) && in.m1447a(this.FJ, castDevice.FJ) && in.m1447a(this.FL, castDevice.FL) && this.FM == castDevice.FM && in.m1447a(this.FN, castDevice.FN) && this.FO == castDevice.FO && this.FP == castDevice.FP;
    }
    ...
    public boolean isSameDevice(CastDevice castDevice) {
        ...
        if (getDeviceId() == null) {
            ...
            return in.m1447a(getDeviceId(), castDevice.getDeviceId());
        }
    }
