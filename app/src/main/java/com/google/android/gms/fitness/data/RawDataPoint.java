...
public final class RawDataPoint implements SafeParcelable {
    public static final Creator<RawDataPoint> CREATOR = new C0295n();
    final int CK;
    final int UJ;
    final int UK;
    final long Ud;
    ...
    RawDataPoint(DataPoint dataPoint, List<DataSource> dataSources) {
        ...
        this.UJ = C0300t.m557a(dataPoint.getDataSource(), dataSources);
        this.UK = C0300t.m557a(dataPoint.getOriginalDataSource(), dataSources);
        this.Uh = dataPoint.js();
        this.Ui = dataPoint.jt();
    }

    /* renamed from: a */
    private boolean m2690a(RawDataPoint rawDataPoint) {
    ...
    public boolean equals(Object o) {
        return this == o || ((o instanceof RawDataPoint) && m2690a((RawDataPoint) o));
    }
    ...
    public void writeToParcel(Parcel parcel, int flags) {
        C0295n.m552a(this, parcel, flags);
    }
}
