...
public final class PlusShare {
    ...
    public static class Builder {
        ...
        public Builder(Activity launchingActivity, PlusClient plusClient) {
            ...
            jx.m1576a(plusClient != null, "PlusClient must not be null.");
            jx.m1576a(plusClient.isConnected(), "PlusClient must be connected to create an interactive post.");
            jx.m1576a(plusClient.os().cj(Scopes.PLUS_LOGIN), "Must request PLUS_LOGIN scope in PlusClient to create an interactive post.");
        ...
        public Builder addCallToAction(String label, Uri uri, String deepLinkId) {
            jx.m1576a(this.anE, "Must include the launching activity with PlusShare.Builder constructor before setting call-to-action");
            boolean z = (uri == null || TextUtils.isEmpty(uri.toString())) ? false : true;
            jx.m1580b(z, (Object) "Must provide a call to action URL");
            ...
            if (!TextUtils.isEmpty(deepLinkId)) {
                jx.m1576a(PlusShare.cg(deepLinkId), "The specified deep-link ID was malformed.");
        ...
        public Intent getIntent() {
            ...
            jx.m1576a(z3, "Call-to-action buttons are only available for URLs.");
            z3 = !booleanExtra || this.mIntent.hasExtra(PlusShare.EXTRA_CONTENT_URL);
            jx.m1576a(z3, "The content URL is required for interactive posts.");
            ...
            jx.m1576a(z, "Must set content URL or content deep-link ID to use a call-to-action button.");
            if (this.mIntent.hasExtra(PlusShare.EXTRA_CONTENT_DEEP_LINK_ID)) {
                jx.m1576a(PlusShare.cg(this.mIntent.getStringExtra(PlusShare.EXTRA_CONTENT_DEEP_LINK_ID)), "The specified deep-link ID was malformed.");
            }
            if (!z2 && equals) {
        ...
        public Builder setContentDeepLinkId(String deepLinkId, String title, String description, Uri thumbnailUri) {
            jx.m1580b(this.anE, (Object) "Must include the launching activity with PlusShare.Builder constructor before setting deep links");
            jx.m1580b(!TextUtils.isEmpty(deepLinkId), (Object) "The deepLinkId parameter is required.");
            Bundle a = PlusShare.m2031a(title, description, thumbnailUri);
    ...
    /* renamed from: a */
    public static Bundle m2031a(String str, String str2, Uri uri) {
        Bundle bundle = new Bundle();
