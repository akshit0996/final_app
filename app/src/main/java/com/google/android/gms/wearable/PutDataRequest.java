...
public class PutDataRequest implements SafeParcelable {
    public static final Creator<PutDataRequest> CREATOR = new C0700e();
    ...
    /* renamed from: k */
    public static PutDataRequest m3850k(Uri uri) {
