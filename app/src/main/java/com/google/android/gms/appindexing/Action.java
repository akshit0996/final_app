...
public final class Action extends Thing {
    ...
    public static final class Builder extends com.google.android.gms.appindexing.Thing.Builder {
        public Builder(String actionType) {
            jx.m1582i(actionType);
            super.put("type", actionType);
        }

        public Action build() {
            jx.m1578b(this.DJ.get("object"), (Object) "setObject is required before calling build().");
            jx.m1578b(this.DJ.get("type"), (Object) "setType is required before calling build().");
            Bundle bundle = (Bundle) this.DJ.getParcelable("object");
            jx.m1578b(bundle.get("name"), (Object) "Must call setObject() with a valid name. Example: setObject(new Thing.Builder().setName(name).setUrl(url))");
            jx.m1578b(bundle.get(PlusShare.KEY_CALL_TO_ACTION_URL), (Object) "Must call setObject() with a valid app url. Example: setObject(new Thing.Builder().setName(name).setUrl(url))");
