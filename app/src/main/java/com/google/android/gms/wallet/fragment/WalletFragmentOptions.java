...
public final class WalletFragmentOptions implements SafeParcelable {
    public static final Creator<WalletFragmentOptions> CREATOR = new C0669b();
    final int CK;
    private int Oi;
    private int avV;
    ...
    /* renamed from: a */
    public static WalletFragmentOptions m3842a(Context context, AttributeSet attributeSet) {
