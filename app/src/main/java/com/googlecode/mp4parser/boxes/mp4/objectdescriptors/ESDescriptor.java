...
public class ESDescriptor extends BaseDescriptor {
    ...
    public void parseDetail(ByteBuffer bb) throws IOException {
        ...
        i = (this.URLFlag == 1 ? this.URLLength + 1 : 0) + (sizeBytes + i);
        if (this.oCRstreamFlag == 1) {
            i2 = 2;
        }
        int baseSize = i + i2;
        ...
        if (getSize() > baseSize + 2) {
            ...
            Logger logger = log;
            StringBuilder append = new StringBuilder().append(descriptor).append(" - ESDescriptor1 read: ").append(read).append(", size: ");
            if (descriptor != null) {
