...
public class CencSampleEncryptionInformationGroupEntry extends GroupEntry {
    static final /* synthetic */ boolean $assertionsDisabled = (!CencSampleEncryptionInformationGroupEntry.class.desiredAssertionStatus() ? true : $assertionsDisabled);
    ...
    public boolean equals(Object o) {
        ...
        return this.isEncrypted != that.isEncrypted ? $assertionsDisabled : this.ivSize != that.ivSize ? $assertionsDisabled : !Arrays.equals(this.kid, that.kid) ? $assertionsDisabled : true;
    }
