...
public class H264TrackImpl extends AbstractTrack {
    /* renamed from: $SWITCH_TABLE$com$googlecode$mp4parser$authoring$tracks$H264TrackImpl$NALActions */
    private static /* synthetic */ int[] f112xebd6cea2;
    ...
    /* renamed from: com.googlecode.mp4parser.authoring.tracks.H264TrackImpl$1 */
    static /* synthetic */ class C07141 {
        /* renamed from: $SwitchMap$com$googlecode$mp4parser$authoring$tracks$H264TrackImpl$NALActions */
        static final /* synthetic */ int[] f48x81bae4c5 = new int[NALActions.values().length];

        static {
            try {
                f48x81bae4c5[NALActions.IGNORE.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f48x81bae4c5[NALActions.BUFFER.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f48x81bae4c5[NALActions.STORE.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f48x81bae4c5[NALActions.END.ordinal()] = 4;
    ...
    public class ByteBufferBackedInputStream extends InputStream {
        ...
        public int read() throws IOException {
            if (this.buf.hasRemaining()) {
                return this.buf.get() & MotionEventCompat.ACTION_MASK;
            }
            return -1;
        }
    ...
    public class SEIMessage {
        ...
        public SEIMessage(InputStream is, SeqParameterSet sps) throws IOException {
            ...
            while (read < datasize) {
                ...
                read++;
                while (last_payload_type_bytes == MotionEventCompat.ACTION_MASK) {
                ...
                read++;
                while (last_payload_size_bytes == MotionEventCompat.ACTION_MASK) {
    ...
    /* renamed from: $SWITCH_TABLE$com$googlecode$mp4parser$authoring$tracks$H264TrackImpl$NALActions */
    static /* synthetic */ int[] m4749xebd6cea2() {
        int[] iArr = f112xebd6cea2;
        if (iArr == null) {
    ...
    private boolean readSamples(LookAhead la) throws IOException {
        if (!this.readSamples) {
            ...
            int frameNr = 0;
            while (true) {
                ByteBuffer sample = findNextSample(la);
                if (sample != null) {
                    int type = sample.get(0);
                    int nal_unit_type = type & 31;
                    switch (m4749xebd6cea2()[handleNALUnit((type >> 5) & 3, nal_unit_type, sample).ordinal()]) {
                        case 1:
                            break;
                        case 2:
                            buffered.add(sample);
