...
public class HandlerBox extends AbstractFullBox {
    ...
    public void _parseDetails(ByteBuffer content) {
        ...
        this.f113a = IsoTypeReader.readUInt32(content);
        this.f114b = IsoTypeReader.readUInt32(content);
        this.f115c = IsoTypeReader.readUInt32(content);
    ...
    protected void getContent(ByteBuffer byteBuffer) {
        ...
        IsoTypeWriter.writeUInt32(byteBuffer, this.f113a);
        IsoTypeWriter.writeUInt32(byteBuffer, this.f114b);
        IsoTypeWriter.writeUInt32(byteBuffer, this.f115c);
        if (this.name != null) {
