...
public class SampleAuxiliaryInformationSizesBox extends AbstractFullBox {
    static final /* synthetic */ boolean $assertionsDisabled = (!SampleAuxiliaryInformationSizesBox.class.desiredAssertionStatus() ? true : $assertionsDisabled);
    ...
    private static /* synthetic */ void ajc$preClinit() {
        ...
        ajc$tjp_7 = factory.makeSJP(JoinPoint.METHOD_EXECUTION, factory.makeMethodSig("1", "setSampleInfoSizes", "com.coremedia.iso.boxes.SampleAuxiliaryInformationSizesBox", "java.util.List", "sampleInfoSizes", "", "void"), (int) TransportMediator.KEYCODE_MEDIA_PAUSE);
    ...
    public void setDefaultSampleInfoSize(int defaultSampleInfoSize) {
        ...
        if ($assertionsDisabled || defaultSampleInfoSize <= MotionEventCompat.ACTION_MASK) {
