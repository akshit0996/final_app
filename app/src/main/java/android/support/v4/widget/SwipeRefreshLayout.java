...
public class SwipeRefreshLayout extends ViewGroup {
    ...
    class C07693 extends BaseAnimationListener {
        C07693() {
            super();
        }
    ...
    class C07704 extends BaseAnimationListener {
        C07704() {
            super();
        }
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        this.mReturnToStartPositionListener = new C07693();
        this.mShrinkAnimationListener = new C07704();
